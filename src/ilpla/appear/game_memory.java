...
public class game_memory extends Activity implements B4AActivity{
	public static game_memory mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ilpla.appear", "ilpla.appear.game_memory");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (game_memory).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ilpla.appear", "ilpla.appear.game_memory");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ilpla.appear.game_memory", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (game_memory) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (game_memory) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (game_memory) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
if (_firsttime) { 
 //BA.debugLineNum = 82;BA.debugLine="Timer1.Initialize(\"Timer1\",500)";
_timer1.Initialize(processBA,"Timer1",(long) (500));
 //BA.debugLineNum = 83;BA.debugLine="Timer2.Initialize(\"Timer1\",4000)";
_timer2.Initialize(processBA,"Timer1",(long) (4000));
 };
 //BA.debugLineNum = 85;BA.debugLine="Activity.LoadLayout(\"MemoryGame.bal\")";
mostCurrent._activity.LoadLayout("MemoryGame.bal",mostCurrent.activityBA);
 //BA.debugLineNum = 86;BA.debugLine="TraducirGUI";
_traducirgui();
 //BA.debugLineNum = 87;BA.debugLine="restart";
_restart();
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 223;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 228;BA.debugLine="lc=loc(0)";
_lc = _loc[(int) (0)];
 //BA.debugLineNum = 229;BA.debugLine="bt=1";
_bt = (int) (1);
...
public static String  _button10_click() throws Exception{
 //BA.debugLineNum = 272;BA.debugLine="Sub Button10_Click";
 //BA.debugLineNum = 273;BA.debugLine="lc=loc(9)";
_lc = _loc[(int) (9)];
 //BA.debugLineNum = 274;BA.debugLine="bt=10";
_bt = (int) (10);
 //BA.debugLineNum = 275;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 276;BA.debugLine="End Sub";
return "";
}
public static String  _button11_click() throws Exception{
 //BA.debugLineNum = 277;BA.debugLine="Sub Button11_Click";
 //BA.debugLineNum = 278;BA.debugLine="lc=loc(10)";
_lc = _loc[(int) (10)];
 //BA.debugLineNum = 279;BA.debugLine="bt=11";
_bt = (int) (11);
 //BA.debugLineNum = 280;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 281;BA.debugLine="End Sub";
return "";
}
public static String  _button12_click() throws Exception{
 //BA.debugLineNum = 282;BA.debugLine="Sub Button12_Click";
 //BA.debugLineNum = 283;BA.debugLine="lc=loc(11)";
_lc = _loc[(int) (11)];
 //BA.debugLineNum = 284;BA.debugLine="bt=12";
_bt = (int) (12);
...
public static String  _button13_click() throws Exception{
 //BA.debugLineNum = 287;BA.debugLine="Sub Button13_Click";
 //BA.debugLineNum = 288;BA.debugLine="lc=loc(12)";
_lc = _loc[(int) (12)];
 //BA.debugLineNum = 289;BA.debugLine="bt=13";
_bt = (int) (13);
...
public static String  _button14_click() throws Exception{
 //BA.debugLineNum = 292;BA.debugLine="Sub Button14_Click";
 //BA.debugLineNum = 293;BA.debugLine="lc=loc(13)";
_lc = _loc[(int) (13)];
 //BA.debugLineNum = 294;BA.debugLine="bt=14";
_bt = (int) (14);
 //BA.debugLineNum = 295;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 296;BA.debugLine="End Sub";
return "";
}
public static String  _button15_click() throws Exception{
 //BA.debugLineNum = 297;BA.debugLine="Sub Button15_Click";
 //BA.debugLineNum = 298;BA.debugLine="lc=loc(14)";
_lc = _loc[(int) (14)];
 //BA.debugLineNum = 299;BA.debugLine="bt=15";
_bt = (int) (15);
 //BA.debugLineNum = 300;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 301;BA.debugLine="End Sub";
return "";
}
public static String  _button16_click() throws Exception{
 //BA.debugLineNum = 302;BA.debugLine="Sub Button16_Click";
 //BA.debugLineNum = 303;BA.debugLine="lc=loc(15)";
_lc = _loc[(int) (15)];
 //BA.debugLineNum = 304;BA.debugLine="bt=16";
_bt = (int) (16);
 //BA.debugLineNum = 305;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 306;BA.debugLine="End Sub";
return "";
}
public static String  _button17_click() throws Exception{
 //BA.debugLineNum = 307;BA.debugLine="Sub Button17_Click";
 //BA.debugLineNum = 308;BA.debugLine="lc=loc(16)";
_lc = _loc[(int) (16)];
 //BA.debugLineNum = 309;BA.debugLine="bt=17";
_bt = (int) (17);
 //BA.debugLineNum = 310;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 311;BA.debugLine="End Sub";
return "";
}
public static String  _button18_click() throws Exception{
 //BA.debugLineNum = 312;BA.debugLine="Sub Button18_Click";
 //BA.debugLineNum = 313;BA.debugLine="lc=loc(17)";
_lc = _loc[(int) (17)];
 //BA.debugLineNum = 314;BA.debugLine="bt=18";
_bt = (int) (18);
...
public static String  _button19_click() throws Exception{
 //BA.debugLineNum = 317;BA.debugLine="Sub Button19_Click";
 //BA.debugLineNum = 318;BA.debugLine="lc=loc(18)";
_lc = _loc[(int) (18)];
 //BA.debugLineNum = 319;BA.debugLine="bt=19";
_bt = (int) (19);
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 232;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 233;BA.debugLine="lc=loc(1)";
_lc = _loc[(int) (1)];
 //BA.debugLineNum = 234;BA.debugLine="bt=2";
_bt = (int) (2);
 //BA.debugLineNum = 235;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 236;BA.debugLine="End Sub";
return "";
}
public static String  _button20_click() throws Exception{
 //BA.debugLineNum = 322;BA.debugLine="Sub Button20_Click";
 //BA.debugLineNum = 323;BA.debugLine="lc=loc(19)";
_lc = _loc[(int) (19)];
 //BA.debugLineNum = 324;BA.debugLine="bt=20";
_bt = (int) (20);
 //BA.debugLineNum = 325;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 326;BA.debugLine="End Sub";
return "";
}
public static String  _button21_click() throws Exception{
 //BA.debugLineNum = 327;BA.debugLine="Sub Button21_Click";
 //BA.debugLineNum = 328;BA.debugLine="tiempo = 0";
_tiempo = (int) (0);
 //BA.debugLineNum = 329;BA.debugLine="restart";
_restart();
 //BA.debugLineNum = 330;BA.debugLine="End Sub";
return "";
}
public static String  _button22_click() throws Exception{
 //BA.debugLineNum = 331;BA.debugLine="Sub Button22_Click";
...
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 237;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 238;BA.debugLine="lc=loc(2)";
_lc = _loc[(int) (2)];
 //BA.debugLineNum = 239;BA.debugLine="bt=3";
_bt = (int) (3);
 //BA.debugLineNum = 240;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 241;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 243;BA.debugLine="lc=loc(3)";
_lc = _loc[(int) (3)];
 //BA.debugLineNum = 244;BA.debugLine="bt=4";
_bt = (int) (4);
 //BA.debugLineNum = 245;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 246;BA.debugLine="End Sub";
return "";
}
public static String  _button5_click() throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Sub Button5_Click";
 //BA.debugLineNum = 248;BA.debugLine="lc=loc(4)";
_lc = _loc[(int) (4)];
 //BA.debugLineNum = 249;BA.debugLine="bt=5";
_bt = (int) (5);
 //BA.debugLineNum = 250;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 251;BA.debugLine="End Sub";
return "";
}
public static String  _button6_click() throws Exception{
 //BA.debugLineNum = 252;BA.debugLine="Sub Button6_Click";
 //BA.debugLineNum = 253;BA.debugLine="lc=loc(5)";
_lc = _loc[(int) (5)];
 //BA.debugLineNum = 254;BA.debugLine="bt=6";
_bt = (int) (6);
...
public static String  _button7_click() throws Exception{
 //BA.debugLineNum = 257;BA.debugLine="Sub Button7_Click";
 //BA.debugLineNum = 258;BA.debugLine="lc=loc(6)";
_lc = _loc[(int) (6)];
 //BA.debugLineNum = 259;BA.debugLine="bt=7";
_bt = (int) (7);
...
public static String  _button8_click() throws Exception{
 //BA.debugLineNum = 262;BA.debugLine="Sub Button8_Click";
 //BA.debugLineNum = 263;BA.debugLine="lc=loc(7)";
_lc = _loc[(int) (7)];
 //BA.debugLineNum = 264;BA.debugLine="bt=8";
_bt = (int) (8);
 //BA.debugLineNum = 265;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 266;BA.debugLine="End Sub";
return "";
}
public static String  _button9_click() throws Exception{
 //BA.debugLineNum = 267;BA.debugLine="Sub Button9_Click";
 //BA.debugLineNum = 268;BA.debugLine="lc=loc(8)";
_lc = _loc[(int) (8)];
 //BA.debugLineNum = 269;BA.debugLine="bt=9";
_bt = (int) (9);
 //BA.debugLineNum = 270;BA.debugLine="calcx";
_calcx();
 //BA.debugLineNum = 271;BA.debugLine="End Sub";
return "";
}
public static String  _calcx() throws Exception{
 //BA.debugLineNum = 612;BA.debugLine="Sub calcx";
 //BA.debugLineNum = 614;BA.debugLine="If busy=\"no\" Then";
if ((mostCurrent._busy).equals("no")) { 
 //BA.debugLineNum = 615;BA.debugLine="clicks=clicks+1";
_clicks = (int) (_clicks+1);
 //BA.debugLineNum = 616;BA.debugLine="tiempo = tiempo + 1";
_tiempo = (int) (_tiempo+1);
 //BA.debugLineNum = 617;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 618;BA.debugLine="lblResultado.Text = \"Movimientos: \" & tiempo";
mostCurrent._lblresultado.setText((Object)("Movimientos: "+BA.NumberToString(_tiempo)));
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 620;BA.debugLine="lblResultado.Text = \"Movements: \" & tiempo";
mostCurrent._lblresultado.setText((Object)("Movements: "+BA.NumberToString(_tiempo)));
 };
 //BA.debugLineNum = 624;BA.debugLine="If clicks<=2 And bt=1 Then";
if (_clicks<=2 && _bt==1) { 
 //BA.debugLineNum = 625;BA.debugLine="button1.visible=False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 628;BA.debugLine="If clicks<=2 And bt=2 Then";
if (_clicks<=2 && _bt==2) { 
 //BA.debugLineNum = 629;BA.debugLine="button2.visible=False";
mostCurrent._button2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 632;BA.debugLine="If clicks<=2 And bt=3 Then";
if (_clicks<=2 && _bt==3) { 
 //BA.debugLineNum = 633;BA.debugLine="button3.visible=False";
mostCurrent._button3.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 636;BA.debugLine="If clicks<=2 And bt=4 Then";
if (_clicks<=2 && _bt==4) { 
 //BA.debugLineNum = 637;BA.debugLine="button4.visible=False";
mostCurrent._button4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 640;BA.debugLine="If clicks<=2 And bt=5 Then";
if (_clicks<=2 && _bt==5) { 
 //BA.debugLineNum = 641;BA.debugLine="button5.visible=False";
mostCurrent._button5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 644;BA.debugLine="If clicks<=2 And bt=6 Then";
if (_clicks<=2 && _bt==6) { 
 //BA.debugLineNum = 645;BA.debugLine="button6.visible=False";
mostCurrent._button6.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 648;BA.debugLine="If clicks<=2 And bt=7 Then";
if (_clicks<=2 && _bt==7) { 
 //BA.debugLineNum = 649;BA.debugLine="button7.visible=False";
mostCurrent._button7.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 652;BA.debugLine="If clicks<=2 And bt=8 Then";
if (_clicks<=2 && _bt==8) { 
 //BA.debugLineNum = 653;BA.debugLine="button8.visible=False";
mostCurrent._button8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 656;BA.debugLine="If clicks<=2 And bt=9 Then";
if (_clicks<=2 && _bt==9) { 
 //BA.debugLineNum = 657;BA.debugLine="button9.visible=False";
mostCurrent._button9.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 660;BA.debugLine="If clicks<=2 And bt=10 Then";
if (_clicks<=2 && _bt==10) { 
 //BA.debugLineNum = 661;BA.debugLine="button10.visible=False";
mostCurrent._button10.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 664;BA.debugLine="If clicks<=2 And bt=11 Then";
if (_clicks<=2 && _bt==11) { 
 //BA.debugLineNum = 665;BA.debugLine="button11.visible=False";
mostCurrent._button11.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 668;BA.debugLine="If clicks<=2 And bt=12 Then";
if (_clicks<=2 && _bt==12) { 
 //BA.debugLineNum = 669;BA.debugLine="button12.visible=False";
mostCurrent._button12.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 672;BA.debugLine="If clicks<=2 And bt=13 Then";
if (_clicks<=2 && _bt==13) { 
 //BA.debugLineNum = 673;BA.debugLine="button13.visible=False";
mostCurrent._button13.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 676;BA.debugLine="If clicks<=2 And bt=14 Then";
if (_clicks<=2 && _bt==14) { 
 //BA.debugLineNum = 677;BA.debugLine="button14.visible=False";
mostCurrent._button14.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 680;BA.debugLine="If clicks<=2 And bt=15 Then";
if (_clicks<=2 && _bt==15) { 
 //BA.debugLineNum = 681;BA.debugLine="button15.visible=False";
mostCurrent._button15.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 684;BA.debugLine="If clicks<=2 And bt=16 Then";
if (_clicks<=2 && _bt==16) { 
 //BA.debugLineNum = 685;BA.debugLine="button16.visible=False";
mostCurrent._button16.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 688;BA.debugLine="If clicks<=2 And bt=17 Then";
if (_clicks<=2 && _bt==17) { 
 //BA.debugLineNum = 689;BA.debugLine="button17.visible=False";
mostCurrent._button17.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 692;BA.debugLine="If clicks<=2 And bt=18 Then";
if (_clicks<=2 && _bt==18) { 
 //BA.debugLineNum = 693;BA.debugLine="button18.visible=False";
mostCurrent._button18.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 696;BA.debugLine="If clicks<=2 And bt=19 Then";
if (_clicks<=2 && _bt==19) { 
 //BA.debugLineNum = 697;BA.debugLine="button19.visible=False";
mostCurrent._button19.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 700;BA.debugLine="If clicks<=2 And bt=20 Then";
if (_clicks<=2 && _bt==20) { 
 //BA.debugLineNum = 701;BA.debugLine="button20.visible=False";
mostCurrent._button20.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 704;BA.debugLine="If clicks=1 Then";
if (_clicks==1) { 
 //BA.debugLineNum = 705;BA.debugLine="Select1=lc";
_select1 = _lc;
 //BA.debugLineNum = 706;BA.debugLine="one=bt";
_one = _bt;
 //BA.debugLineNum = 707;BA.debugLine="loc1=bt";
_loc1 = _bt;
 };
 //BA.debugLineNum = 710;BA.debugLine="If clicks=2 Then";
if (_clicks==2) { 
 //BA.debugLineNum = 711;BA.debugLine="select2=lc";
_select2 = _lc;
 //BA.debugLineNum = 712;BA.debugLine="two=bt";
_two = _bt;
 //BA.debugLineNum = 713;BA.debugLine="If Select1=select2 Then";
if (_select1==_select2) { 
 //BA.debugLineNum = 714;BA.debugLine="match=match+1";
_match = (int) (_match+1);
 }else {
 //BA.debugLineNum = 716;BA.debugLine="loc2=bt";
_loc2 = _bt;
 //BA.debugLineNum = 717;BA.debugLine="busy=\"yes\"";
mostCurrent._busy = "yes";
 //BA.debugLineNum = 718;BA.debugLine="Timer1.Enabled=True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 720;BA.debugLine="clicks=0";
_clicks = (int) (0);
 };
 //BA.debugLineNum = 723;BA.debugLine="If match=10 Then";
if (_match==10) { 
 //BA.debugLineNum = 724;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 725;BA.debugLine="utilidades.Mensaje(\"Felicitaciones!\", \"Utilizas";
mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Felicitaciones!","Utilizaste "+BA.NumberToString(_tiempo)+" movimientos","OK","","");
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 727;BA.debugLine="utilidades.Mensaje(\"Congratulations!\", \"You use";
mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Congratulations!","You used "+BA.NumberToString(_tiempo)+" movements","OK","","");
 };
 };
 };
...
public static String  _delayx() throws Exception{
 //BA.debugLineNum = 335;BA.debugLine="Sub delayx";
 //BA.debugLineNum = 337;BA.debugLine="For x=1 To 1000000";
{
final int step1 = 1;
...
for (_x = (int) (1) ; (step1 > 0 && _x <= limit1) || (step1 < 0 && _x >= limit1); _x = ((int)(0 + _x + step1)) ) {
 ...
 //BA.debugLineNum = 340;BA.debugLine="If loc1=1 Or loc2=1 Then";
if (_loc1==1 || _loc2==1) { 
 //BA.debugLineNum = 341;BA.debugLine="button1.visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 344;BA.debugLine="If loc1=2 Or loc2=2 Then";
if (_loc1==2 || _loc2==2) { 
 //BA.debugLineNum = 345;BA.debugLine="button2.visible=True";
mostCurrent._button2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 348;BA.debugLine="If loc1=3 Or loc2=3 Then";
if (_loc1==3 || _loc2==3) { 
...
mostCurrent._button3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 ...
 //BA.debugLineNum = 352;BA.debugLine="If loc1=4 Or loc2=4 Then";
if (_loc1==4 || _loc2==4) { 
 //BA.debugLineNum = 353;BA.debugLine="button4.visible=True";
mostCurrent._button4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 356;BA.debugLine="If loc1=5 Or loc2=5 Then";
if (_loc1==5 || _loc2==5) { 
 //BA.debugLineNum = 357;BA.debugLine="button5.visible=True";
mostCurrent._button5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 360;BA.debugLine="If loc1=6 Or loc2=6 Then";
if (_loc1==6 || _loc2==6) { 
 //BA.debugLineNum = 361;BA.debugLine="button6.visible=True";
mostCurrent._button6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 364;BA.debugLine="If loc1=7 Or loc2=7 Then";
if (_loc1==7 || _loc2==7) { 
 //BA.debugLineNum = 365;BA.debugLine="button7.visible=True";
mostCurrent._button7.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 368;BA.debugLine="If loc1=8 Or loc2=8 Then";
if (_loc1==8 || _loc2==8) { 
 //BA.debugLineNum = 369;BA.debugLine="button8.visible=True";
mostCurrent._button8.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 372;BA.debugLine="If loc1=9 Or loc2=9 Then";
if (_loc1==9 || _loc2==9) { 
 //BA.debugLineNum = 373;BA.debugLine="button9.visible=True";
mostCurrent._button9.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 376;BA.debugLine="If loc1=10 Or loc2=10 Then";
if (_loc1==10 || _loc2==10) { 
 //BA.debugLineNum = 377;BA.debugLine="button10.visible=True";
mostCurrent._button10.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 380;BA.debugLine="If loc1=11 Or loc2=11 Then";
if (_loc1==11 || _loc2==11) { 
 //BA.debugLineNum = 381;BA.debugLine="button11.visible=True";
mostCurrent._button11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 384;BA.debugLine="If loc1=12 Or loc2=12 Then";
if (_loc1==12 || _loc2==12) { 
 //BA.debugLineNum = 385;BA.debugLine="button12.visible=True";
mostCurrent._button12.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 388;BA.debugLine="If loc1=13 Or loc2=13 Then";
if (_loc1==13 || _loc2==13) { 
 //BA.debugLineNum = 389;BA.debugLine="button13.visible=True";
mostCurrent._button13.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 392;BA.debugLine="If loc1=14 Or loc2=14 Then";
if (_loc1==14 || _loc2==14) { 
 //BA.debugLineNum = 393;BA.debugLine="button14.visible=True";
mostCurrent._button14.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 396;BA.debugLine="If loc1=15 Or loc2=15 Then";
if (_loc1==15 || _loc2==15) { 
 //BA.debugLineNum = 397;BA.debugLine="button15.visible=True";
mostCurrent._button15.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 400;BA.debugLine="If loc1=16 Or loc2=16 Then";
if (_loc1==16 || _loc2==16) { 
 //BA.debugLineNum = 401;BA.debugLine="button16.visible=True";
mostCurrent._button16.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 404;BA.debugLine="If loc1=17 Or loc2=17 Then";
if (_loc1==17 || _loc2==17) { 
 //BA.debugLineNum = 405;BA.debugLine="button17.visible=True";
mostCurrent._button17.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 408;BA.debugLine="If loc1=18 Or loc2=18 Then";
if (_loc1==18 || _loc2==18) { 
 //BA.debugLineNum = 409;BA.debugLine="button18.visible=True";
mostCurrent._button18.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 412;BA.debugLine="If loc1=19 Or loc2=19 Then";
if (_loc1==19 || _loc2==19) { 
 //BA.debugLineNum = 413;BA.debugLine="button19.visible=True";
mostCurrent._button19.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 416;BA.debugLine="If loc1=20 Or loc2=20 Then";
if (_loc1==20 || _loc2==20) { 
 //BA.debugLineNum = 417;BA.debugLine="button20.visible=True";
mostCurrent._button20.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 420;BA.debugLine="busy=\"no\"";
...
_two = 0;
 //BA.debugLineNum = 75;BA.debugLine="Private Button21 As Button";
mostCurrent._button21 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 76;BA.debugLine="Private Button22 As Button";
mostCurrent._button22 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 77;BA.debugLine="Private lblResultado As Label";
mostCurrent._lblresultado = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return "";
}
public static String  _mix() throws Exception{
 //BA.debugLineNum = 599;BA.debugLine="Sub mix";
 //BA.debugLineNum = 601;BA.debugLine="If loc(x)=0 Then";
if (_loc[_x]==0) { 
 //BA.debugLineNum = 602;BA.debugLine="y=Rnd(0,20)";
_y = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (20));
 };
 //BA.debugLineNum = 605;BA.debugLine="If sel(y) >0 And loc(x)=0 Then";
if (_sel[_y]>0 && _loc[_x]==0) { 
 //BA.debugLineNum = 606;BA.debugLine="loc(x)=sel(y)";
_loc[_x] = _sel[_y];
 //BA.debugLineNum = 607;BA.debugLine="sel(y)=0";
_sel[_y] = (int) (0);
 };
...
int _a = 0;
 //BA.debugLineNum = 107;BA.debugLine="Sub restart";
 //BA.debugLineNum = 108;BA.debugLine="Button21.BringToFront";
mostCurrent._button21.BringToFront();
 //BA.debugLineNum = 109;BA.debugLine="Button22.BringToFront";
mostCurrent._button22.BringToFront();
 //BA.debugLineNum = 111;BA.debugLine="For x=0 To 19";
{
final int step3 = 1;
final int limit3 = (int) (19);
for (_x = (int) (0) ; (step3 > 0 && _x <= limit3) || (step3 < 0 && _x >= limit3); _x = ((int)(0 + _x + step3)) ) {
 //BA.debugLineNum = 112;BA.debugLine="loc(x)=0";
_loc[_x] = (int) (0);
 }
};
 //BA.debugLineNum = 116;BA.debugLine="For x=0 To 19";
{
final int step6 = 1;
final int limit6 = (int) (19);
for (_x = (int) (0) ; (step6 > 0 && _x <= limit6) || (step6 < 0 && _x >= limit6); _x = ((int)(0 + _x + step6)) ) {
 //BA.debugLineNum = 117;BA.debugLine="loc(x)=0";
_loc[_x] = (int) (0);
 }
};
 //BA.debugLineNum = 120;BA.debugLine="Dim a As Int";
_a = 0;
 //BA.debugLineNum = 122;BA.debugLine="For a=0 To 9";
{
final int step10 = 1;
final int limit10 = (int) (9);
for (_a = (int) (0) ; (step10 > 0 && _a <= limit10) || (step10 < 0 && _a >= limit10); _a = ((int)(0 + _a + step10)) ) {
 //BA.debugLineNum = 123;BA.debugLine="sel(a)=a+1";
_sel[_a] = (int) (_a+1);
 }
};
 //BA.debugLineNum = 126;BA.debugLine="For a=10 To 19";
{
final int step13 = 1;
final int limit13 = (int) (19);
for (_a = (int) (10) ; (step13 > 0 && _a <= limit13) || (step13 < 0 && _a >= limit13); _a = ((int)(0 + _a + step13)) ) {
 //BA.debugLineNum = 127;BA.debugLine="sel(a)=a-9";
_sel[_a] = (int) (_a-9);
 }
};
 //BA.debugLineNum = 131;BA.debugLine="For z=1 To 100";
{
final int step16 = 1;
final int limit16 = (int) (100);
for (_z = (int) (1) ; (step16 > 0 && _z <= limit16) || (step16 < 0 && _z >= limit16); _z = ((int)(0 + _z + step16)) ) {
 //BA.debugLineNum = 132;BA.debugLine="For x=0 To 19";
{
final int step17 = 1;
final int limit17 = (int) (19);
for (_x = (int) (0) ; (step17 > 0 && _x <= limit17) || (step17 < 0 && _x >= limit17); _x = ((int)(0 + _x + step17)) ) {
 //BA.debugLineNum = 133;BA.debugLine="If loc(x)=0 Then";
if (_loc[_x]==0) { 
 //BA.debugLineNum = 134;BA.debugLine="mix";
_mix();
 };
 }
};
 ...
 //BA.debugLineNum = 142;BA.debugLine="clicks=0";
_clicks = (int) (0);
 //BA.debugLineNum = 143;BA.debugLine="Timer1.Enabled=False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 144;BA.debugLine="loc1=0";
_loc1 = (int) (0);
 //BA.debugLineNum = 145;BA.debugLine="loc2=0";
_loc2 = (int) (0);
 //BA.debugLineNum = 148;BA.debugLine="button1.visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 149;BA.debugLine="button2.visible=True";
mostCurrent._button2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 150;BA.debugLine="button3.visible=True";
mostCurrent._button3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 151;BA.debugLine="button4.visible=True";
mostCurrent._button4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 152;BA.debugLine="button5.visible=True";
mostCurrent._button5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 153;BA.debugLine="button6.visible=True";
mostCurrent._button6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 154;BA.debugLine="button7.visible=True";
mostCurrent._button7.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 155;BA.debugLine="button8.visible=True";
mostCurrent._button8.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 156;BA.debugLine="button9.visible=True";
mostCurrent._button9.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 157;BA.debugLine="button10.visible=True";
mostCurrent._button10.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 158;BA.debugLine="button11.visible=True";
mostCurrent._button11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 159;BA.debugLine="button12.visible=True";
mostCurrent._button12.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 160;BA.debugLine="button13.visible=True";
mostCurrent._button13.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 161;BA.debugLine="button14.visible=True";
mostCurrent._button14.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 162;BA.debugLine="button15.visible=True";
mostCurrent._button15.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 163;BA.debugLine="button16.visible=True";
mostCurrent._button16.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 164;BA.debugLine="button17.visible=True";
mostCurrent._button17.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 165;BA.debugLine="button18.visible=True";
mostCurrent._button18.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 166;BA.debugLine="button19.visible=True";
mostCurrent._button19.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 167;BA.debugLine="button20.visible=True";
mostCurrent._button20.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 172;BA.debugLine="ImageView1.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (0)])+".gif").getObject()));
 //BA.debugLineNum = 173;BA.debugLine="ImageView2.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (1)])+".gif").getObject()));
 //BA.debugLineNum = 174;BA.debugLine="ImageView3.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (2)])+".gif").getObject()));
 //BA.debugLineNum = 175;BA.debugLine="ImageView4.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview4.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (3)])+".gif").getObject()));
 //BA.debugLineNum = 176;BA.debugLine="ImageView5.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview5.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (4)])+".gif").getObject()));
 //BA.debugLineNum = 177;BA.debugLine="ImageView6.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview6.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (5)])+".gif").getObject()));
 //BA.debugLineNum = 178;BA.debugLine="ImageView7.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview7.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (6)])+".gif").getObject()));
 //BA.debugLineNum = 179;BA.debugLine="ImageView8.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview8.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (7)])+".gif").getObject()));
 //BA.debugLineNum = 180;BA.debugLine="ImageView9.Bitmap = LoadBitmap(File.DirAssets, lo";
mostCurrent._imageview9.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (8)])+".gif").getObject()));
 //BA.debugLineNum = 181;BA.debugLine="ImageView10.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview10.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (9)])+".gif").getObject()));
 //BA.debugLineNum = 182;BA.debugLine="ImageView11.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview11.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (10)])+".gif").getObject()));
 //BA.debugLineNum = 183;BA.debugLine="ImageView12.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview12.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (11)])+".gif").getObject()));
 //BA.debugLineNum = 184;BA.debugLine="ImageView13.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview13.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (12)])+".gif").getObject()));
 //BA.debugLineNum = 185;BA.debugLine="ImageView14.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview14.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (13)])+".gif").getObject()));
 //BA.debugLineNum = 186;BA.debugLine="ImageView15.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview15.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (14)])+".gif").getObject()));
 //BA.debugLineNum = 187;BA.debugLine="ImageView16.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview16.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (15)])+".gif").getObject()));
 //BA.debugLineNum = 188;BA.debugLine="ImageView17.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview17.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (16)])+".gif").getObject()));
 //BA.debugLineNum = 189;BA.debugLine="ImageView18.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview18.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (17)])+".gif").getObject()));
 //BA.debugLineNum = 190;BA.debugLine="ImageView19.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview19.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (18)])+".gif").getObject()));
 //BA.debugLineNum = 191;BA.debugLine="ImageView20.Bitmap = LoadBitmap(File.DirAssets, l";
mostCurrent._imageview20.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),BA.NumberToString(_loc[(int) (19)])+".gif").getObject()));
 //BA.debugLineNum = 193;BA.debugLine="ImageView1.SendToBack";
mostCurrent._imageview1.SendToBack();
 //BA.debugLineNum = 194;BA.debugLine="ImageView2.SendToBack";
mostCurrent._imageview2.SendToBack();
 //BA.debugLineNum = 195;BA.debugLine="ImageView3.SendToBack";
mostCurrent._imageview3.SendToBack();
 //BA.debugLineNum = 196;BA.debugLine="ImageView4.SendToBack";
mostCurrent._imageview4.SendToBack();
 //BA.debugLineNum = 197;BA.debugLine="ImageView5.SendToBack";
mostCurrent._imageview5.SendToBack();
 //BA.debugLineNum = 198;BA.debugLine="ImageView6.SendToBack";
mostCurrent._imageview6.SendToBack();
 //BA.debugLineNum = 199;BA.debugLine="ImageView7.SendToBack";
mostCurrent._imageview7.SendToBack();
 //BA.debugLineNum = 200;BA.debugLine="ImageView8.SendToBack";
mostCurrent._imageview8.SendToBack();
 //BA.debugLineNum = 201;BA.debugLine="ImageView9.SendToBack";
mostCurrent._imageview9.SendToBack();
 //BA.debugLineNum = 202;BA.debugLine="ImageView10.SendToBack";
mostCurrent._imageview10.SendToBack();
 //BA.debugLineNum = 203;BA.debugLine="ImageView11.SendToBack";
mostCurrent._imageview11.SendToBack();
 //BA.debugLineNum = 204;BA.debugLine="ImageView12.SendToBack";
mostCurrent._imageview12.SendToBack();
 //BA.debugLineNum = 205;BA.debugLine="ImageView13.SendToBack";
mostCurrent._imageview13.SendToBack();
 //BA.debugLineNum = 206;BA.debugLine="ImageView14.SendToBack";
mostCurrent._imageview14.SendToBack();
 //BA.debugLineNum = 207;BA.debugLine="ImageView15.SendToBack";
mostCurrent._imageview15.SendToBack();
 //BA.debugLineNum = 208;BA.debugLine="ImageView16.SendToBack";
mostCurrent._imageview16.SendToBack();
 //BA.debugLineNum = 209;BA.debugLine="ImageView17.SendToBack";
mostCurrent._imageview17.SendToBack();
 //BA.debugLineNum = 210;BA.debugLine="ImageView18.SendToBack";
mostCurrent._imageview18.SendToBack();
 //BA.debugLineNum = 211;BA.debugLine="ImageView19.SendToBack";
mostCurrent._imageview19.SendToBack();
 //BA.debugLineNum = 212;BA.debugLine="ImageView20.SendToBack";
mostCurrent._imageview20.SendToBack();
 //BA.debugLineNum = 214;BA.debugLine="busy=\"no\"";
mostCurrent._busy = "no";
 //BA.debugLineNum = 216;BA.debugLine="match=0";
_match = (int) (0);
 //BA.debugLineNum = 217;BA.debugLine="End Sub";
return "";
}
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 509;BA.debugLine="Sub Timer1_Tick";
 //BA.debugLineNum = 512;BA.debugLine="If loc1=1 Or loc2=1 Then";
if (_loc1==1 || _loc2==1) { 
 //BA.debugLineNum = 513;BA.debugLine="button1.visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 516;BA.debugLine="If loc1=2 Or loc2=2 Then";
if (_loc1==2 || _loc2==2) { 
 //BA.debugLineNum = 517;BA.debugLine="button2.visible=True";
mostCurrent._button2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 520;BA.debugLine="If loc1=3 Or loc2=3 Then";
if (_loc1==3 || _loc2==3) { 
 //BA.debugLineNum = 521;BA.debugLine="button3.visible=True";
mostCurrent._button3.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 524;BA.debugLine="If loc1=4 Or loc2=4 Then";
if (_loc1==4 || _loc2==4) { 
 //BA.debugLineNum = 525;BA.debugLine="button4.visible=True";
mostCurrent._button4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 528;BA.debugLine="If loc1=5 Or loc2=5 Then";
if (_loc1==5 || _loc2==5) { 
 //BA.debugLineNum = 529;BA.debugLine="button5.visible=True";
mostCurrent._button5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 532;BA.debugLine="If loc1=6 Or loc2=6 Then";
if (_loc1==6 || _loc2==6) { 
 //BA.debugLineNum = 533;BA.debugLine="button6.visible=True";
mostCurrent._button6.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 536;BA.debugLine="If loc1=7 Or loc2=7 Then";
if (_loc1==7 || _loc2==7) { 
 //BA.debugLineNum = 537;BA.debugLine="button7.visible=True";
mostCurrent._button7.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 540;BA.debugLine="If loc1=8 Or loc2=8 Then";
if (_loc1==8 || _loc2==8) { 
 //BA.debugLineNum = 541;BA.debugLine="button8.visible=True";
mostCurrent._button8.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 544;BA.debugLine="If loc1=9 Or loc2=9 Then";
if (_loc1==9 || _loc2==9) { 
 //BA.debugLineNum = 545;BA.debugLine="button9.visible=True";
mostCurrent._button9.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 548;BA.debugLine="If loc1=10 Or loc2=10 Then";
if (_loc1==10 || _loc2==10) { 
 //BA.debugLineNum = 549;BA.debugLine="button10.visible=True";
mostCurrent._button10.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 552;BA.debugLine="If loc1=11 Or loc2=11 Then";
if (_loc1==11 || _loc2==11) { 
 //BA.debugLineNum = 553;BA.debugLine="button11.visible=True";
mostCurrent._button11.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 557;BA.debugLine="If loc1=12 Or loc2=12 Then";
if (_loc1==12 || _loc2==12) { 
 //BA.debugLineNum = 558;BA.debugLine="button12.visible=True";
mostCurrent._button12.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 561;BA.debugLine="If loc1=13 Or loc2=13 Then";
if (_loc1==13 || _loc2==13) { 
 //BA.debugLineNum = 562;BA.debugLine="button13.visible=True";
mostCurrent._button13.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 565;BA.debugLine="If loc1=14 Or loc2=14 Then";
if (_loc1==14 || _loc2==14) { 
 //BA.debugLineNum = 566;BA.debugLine="button14.visible=True";
mostCurrent._button14.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 569;BA.debugLine="If loc1=15 Or loc2=15 Then";
if (_loc1==15 || _loc2==15) { 
 //BA.debugLineNum = 570;BA.debugLine="button15.visible=True";
mostCurrent._button15.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 573;BA.debugLine="If loc1=16 Or loc2=16 Then";
if (_loc1==16 || _loc2==16) { 
 //BA.debugLineNum = 574;BA.debugLine="button16.visible=True";
mostCurrent._button16.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 577;BA.debugLine="If loc1=17 Or loc2=17 Then";
if (_loc1==17 || _loc2==17) { 
 //BA.debugLineNum = 578;BA.debugLine="button17.visible=True";
mostCurrent._button17.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 581;BA.debugLine="If loc1=18 Or loc2=18 Then";
if (_loc1==18 || _loc2==18) { 
 //BA.debugLineNum = 582;BA.debugLine="button18.visible=True";
mostCurrent._button18.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 585;BA.debugLine="If loc1=19 Or loc2=19 Then";
if (_loc1==19 || _loc2==19) { 
 //BA.debugLineNum = 586;BA.debugLine="button19.visible=True";
mostCurrent._button19.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 589;BA.debugLine="If loc1=20 Or loc2=20 Then";
if (_loc1==20 || _loc2==20) { 
 //BA.debugLineNum = 590;BA.debugLine="button20.visible=True";
mostCurrent._button20.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 593;BA.debugLine="busy=\"no\"";
mostCurrent._busy = "no";
 //BA.debugLineNum = 595;BA.debugLine="Timer1.Enabled=False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 597;BA.debugLine="End Sub";
return "";
}
public static String  _timer2_tick() throws Exception{
 //BA.debugLineNum = 424;BA.debugLine="Sub Timer2_Tick";
 //BA.debugLineNum = 426;BA.debugLine="If one=1  Or two=1 Then";
if (_one==1 || _two==1) { 
 //BA.debugLineNum = 427;BA.debugLine="ImageView1.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Black.gif").getObject()));
 ...
 //BA.debugLineNum = 430;BA.debugLine="If one=2  Or two=2 Then";
if (_one==2 || _two==2) { 
 //BA.debugLineNum = 431;BA.debugLine="ImageView2.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 434;BA.debugLine="If one=3  Or two=3 Then";
if (_one==3 || _two==3) { 
 //BA.debugLineNum = 435;BA.debugLine="ImageView3.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 438;BA.debugLine="If one=4  Or two=4 Then";
if (_one==4 || _two==4) { 
 //BA.debugLineNum = 439;BA.debugLine="ImageView4.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview4.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 442;BA.debugLine="If one=5  Or two=5 Then";
if (_one==5 || _two==5) { 
 //BA.debugLineNum = 443;BA.debugLine="ImageView5.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview5.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 446;BA.debugLine="If one=6  Or two=6 Then";
if (_one==6 || _two==6) { 
 //BA.debugLineNum = 447;BA.debugLine="ImageView6.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview6.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 450;BA.debugLine="If one=7  Or two=7 Then";
if (_one==7 || _two==7) { 
 //BA.debugLineNum = 451;BA.debugLine="ImageView7.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview7.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 454;BA.debugLine="If one=8  Or two=8 Then";
if (_one==8 || _two==8) { 
 //BA.debugLineNum = 455;BA.debugLine="ImageView8.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview8.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 458;BA.debugLine="If one=9  Or two=9 Then";
if (_one==9 || _two==9) { 
 //BA.debugLineNum = 459;BA.debugLine="ImageView9.Bitmap = LoadBitmap(File.DirAssets, \"";
mostCurrent._imageview9.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 462;BA.debugLine="If one=10 Or two=10 Then";
if (_one==10 || _two==10) { 
 //BA.debugLineNum = 463;BA.debugLine="ImageView10.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview10.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 466;BA.debugLine="If one=11  Or two=11 Then";
if (_one==11 || _two==11) { 
 //BA.debugLineNum = 467;BA.debugLine="ImageView11.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview11.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 470;BA.debugLine="If one=12  Or two=12 Then";
if (_one==12 || _two==12) { 
 //BA.debugLineNum = 471;BA.debugLine="ImageView12.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview12.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 474;BA.debugLine="If one=13  Or two=13 Then";
if (_one==13 || _two==13) { 
 //BA.debugLineNum = 475;BA.debugLine="ImageView13.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview13.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 478;BA.debugLine="If one=14  Or two=14 Then";
if (_one==14 || _two==14) { 
 //BA.debugLineNum = 479;BA.debugLine="ImageView14.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview14.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 482;BA.debugLine="If one=15  Or two=15 Then";
if (_one==15 || _two==15) { 
 //BA.debugLineNum = 483;BA.debugLine="ImageView15.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview15.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 486;BA.debugLine="If one=16  Or two=16 Then";
if (_one==16 || _two==16) { 
 //BA.debugLineNum = 487;BA.debugLine="ImageView16.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview16.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 490;BA.debugLine="If one=17  Or two=17 Then";
if (_one==17 || _two==17) { 
 //BA.debugLineNum = 491;BA.debugLine="ImageView17.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview17.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 494;BA.debugLine="If one=18  Or two=18 Then";
if (_one==18 || _two==18) { 
 //BA.debugLineNum = 495;BA.debugLine="ImageView18.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview18.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 498;BA.debugLine="If one=19  Or two=19 Then";
if (_one==19 || _two==19) { 
 //BA.debugLineNum = 499;BA.debugLine="ImageView19.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview19.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 502;BA.debugLine="If one=20  Or two=20 Then";
if (_one==20 || _two==20) { 
 //BA.debugLineNum = 503;BA.debugLine="ImageView20.Bitmap = LoadBitmap(File.DirAssets,";
mostCurrent._imageview20.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"black.gif").getObject()));
 ...
 //BA.debugLineNum = 506;BA.debugLine="Timer2.Enabled=False";
...
public static String  _timer3_tick() throws Exception{
 //BA.debugLineNum = 219;BA.debugLine="Sub Timer3_Tick";
 //BA.debugLineNum = 221;BA.debugLine="End Sub";
return "";
}
public static String  _traducirgui() throws Exception{
 //BA.debugLineNum = 102;BA.debugLine="Sub TraducirGUI";

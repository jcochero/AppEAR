...
public class game_comunidades extends Activity implements B4AActivity{
	public static game_comunidades mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ilpla.appear", "ilpla.appear.game_comunidades");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (game_comunidades).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ilpla.appear", "ilpla.appear.game_comunidades");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ilpla.appear.game_comunidades", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (game_comunidades) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (game_comunidades) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (game_comunidades) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 60;BA.debugLine="If origen = \"aprender\" Then";
...
_verinstruccionescomunidades = anywheresoftware.b4a.keywords.Common.True;
 ...
 //BA.debugLineNum = 64;BA.debugLine="Activity.LoadLayout(\"Game_Comunidades\")";
mostCurrent._activity.LoadLayout("Game_Comunidades",mostCurrent.activityBA);
...
public static String  _butcerrar_click() throws Exception{
 //BA.debugLineNum = 599;BA.debugLine="Sub butCerrar_Click";
...
public static String  _buthelp_click() throws Exception{
 //BA.debugLineNum = 604;BA.debugLine="Sub butHelp_Click";
 //BA.debugLineNum = 605;BA.debugLine="verInstruccionesComunidades = True";
_verinstruccionescomunidades = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 606;BA.debugLine="p.SetScreenOrientation(1)";
...
public static String  _butok_click() throws Exception{
 //BA.debugLineNum = 330;BA.debugLine="Sub butOK_Click";
 //BA.debugLineNum = 331;BA.debugLine="verInstruccionesComunidades = False";
_verinstruccionescomunidades = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 332;BA.debugLine="origen = \"\"";
_origen = "";
 //BA.debugLineNum = 333;BA.debugLine="p.SetScreenOrientation(0)";
mostCurrent._p.SetScreenOrientation(processBA,(int) (0));
 //BA.debugLineNum = 334;BA.debugLine="End Sub";
return "";
}
public static String  _butreset_click() throws Exception{
 //BA.debugLineNum = 594;BA.debugLine="Sub butReset_Click";
 //BA.debugLineNum = 595;BA.debugLine="verInstruccionesComunidades = True";
_verinstruccionescomunidades = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 596;BA.debugLine="p.SetScreenOrientation(1)";
mostCurrent._p.SetScreenOrientation(processBA,(int) (1));
...
_header5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 198;BA.debugLine="headerInst.TextSize = 26";
...
_lineinst = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-comunidadesInst.txt");
...
_line1 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-comunidades1.txt");
...
_line2 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-comunidades2.txt");
...
_line3 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-comunidades3.txt");
...
_line4 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-comunidades4.txt");
...
_line5 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-comunidades5.txt");
...
_panel5.getPanel().AddView((android.view.View)(_texto5.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA));
 //BA.debugLineNum = 304;BA.debugLine="Dim butOK As Button";
_butok = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 305;BA.debugLine="butOK.Initialize(\"butOK\")";
_butok.Initialize(mostCurrent.activityBA,"butOK");
 //BA.debugLineNum = 306;BA.debugLine="butOK.Text = \"OK\"";
_butok.setText((Object)("OK"));
 //BA.debugLineNum = 307;BA.debugLine="butOK.Color = Colors.ARGB(255,73,202,138)";
_butok.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (73),(int) (202),(int) (138)));
 //BA.debugLineNum = 308;BA.debugLine="butOK.TextColor = Colors.White";
_butok.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 311;BA.debugLine="Dim flechas As Label";
_flechas = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 312;BA.debugLine="flechas.Initialize(\"\")";
_flechas.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 313;BA.debugLine="flechas.TextSize = 18";
_flechas.setTextSize((float) (18));
 //BA.debugLineNum = 314;BA.debugLine="flechas.TextColor = Colors.ARGB(255, 73,202,138)";
_flechas.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (73),(int) (202),(int) (138)));
 //BA.debugLineNum = 315;BA.debugLine="flechas.Gravity = Gravity.CENTER";
_flechas.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 316;BA.debugLine="If Main.lang = \"en\" Then";
if ((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 317;BA.debugLine="flechas.Text = \"<< Scroll for more info >>\"";
_flechas.setText((Object)("<< Scroll for more info >>"));
 }else {
 //BA.debugLineNum = 319;BA.debugLine="flechas.Text = \"<< Desliza para mas información";
_flechas.setText((Object)("<< Desliza para mas información >>"));
 };
 //BA.debugLineNum = 324;BA.debugLine="Activity.AddView(butOK, 0,90%y,100%x,10%y)";
mostCurrent._activity.AddView((android.view.View)(_butok.getObject()),(int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 325;BA.debugLine="Activity.AddView(flechas, 0, 80%y, 100%x, 10%y)";
...
String _ms = "";
 //BA.debugLineNum = 564;BA.debugLine="Sub Chequear";
 //BA.debugLineNum = 565;BA.debugLine="If word1.Tag = \"OK\" And word2.Tag = \"OK\" And word";
if ((mostCurrent._word1.getTag()).equals((Object)("OK")) && (mostCurrent._word2.getTag()).equals((Object)("OK")) && (mostCurrent._word3.getTag()).equals((Object)("OK")) && (mostCurrent._word4.getTag()).equals((Object)("OK")) && (mostCurrent._word5.getTag()).equals((Object)("OK"))) { 
 //BA.debugLineNum = 566;BA.debugLine="word1.Enabled = False";
mostCurrent._word1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 567;BA.debugLine="word2.Enabled = False";
mostCurrent._word2.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 568;BA.debugLine="word3.Enabled = False";
mostCurrent._word3.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 569;BA.debugLine="word4.Enabled = False";
mostCurrent._word4.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 570;BA.debugLine="word5.Enabled = False";
mostCurrent._word5.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 572;BA.debugLine="Dim ms As String";
_ms = "";
 //BA.debugLineNum = 573;BA.debugLine="If Main.lang = \"en\" Then";
if ((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 574;BA.debugLine="ms = utilidades.Mensaje(\"Congratulations!\", \"Yo";
_ms = mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Congratulations!","You have correctly named every aquatic community!","OK","","");
 }else {
 //BA.debugLineNum = 576;BA.debugLine="ms = utilidades.Mensaje(\"Felicitaciones!\", \"Has";
_ms = mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Felicitaciones!","Has nombrado correctamente a cada comunidad acuática!","OK","","");
 };
 //BA.debugLineNum = 579;BA.debugLine="If ms = DialogResponse.POSITIVE Then";
...
mostCurrent._word1.setText((Object)("Plankton"));
 //BA.debugLineNum = 116;BA.debugLine="word2.Text = \"Nekton\"";
mostCurrent._word2.setText((Object)("Nekton"));
 //BA.debugLineNum = 117;BA.debugLine="word3.text = \"Neuston\"";
mostCurrent._word3.setText((Object)("Neuston"));
 //BA.debugLineNum = 118;BA.debugLine="word4.Text = \"Benthos\"";
mostCurrent._word4.setText((Object)("Benthos"));
 //BA.debugLineNum = 119;BA.debugLine="word5.Text = \"Macrophyte\"";
mostCurrent._word5.setText((Object)("Macrophyte"));
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 366;BA.debugLine="Sub word1_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 368;BA.debugLine="Dim newleft As Int = Max(0, Min(word1.Left + del";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word1.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word1.getWidth())));
 //BA.debugLineNum = 369;BA.debugLine="Dim newtop As Int = Max(0, Min(word1.Top + delta";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word1.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word1.getHeight())));
 //BA.debugLineNum = 370;BA.debugLine="word1.Left = newleft";
mostCurrent._word1.setLeft(_newleft);
 //BA.debugLineNum = 371;BA.debugLine="word1.Top = newtop";
mostCurrent._word1.setTop(_newtop);
 //BA.debugLineNum = 372;BA.debugLine="word1.Tag = \"\"";
mostCurrent._word1.setTag((Object)(""));
 //BA.debugLineNum = 373;BA.debugLine="checkOK1.Left = 6000dip";
mostCurrent._checkok1.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 374;BA.debugLine="checkOK1.Top = 6000dip";
mostCurrent._checkok1.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 375;BA.debugLine="If word1.Left >= slot1.Left And word1.Left <= sl";
if (mostCurrent._word1.getLeft()>=mostCurrent._slot1.getLeft() && mostCurrent._word1.getLeft()<=mostCurrent._slot1.getLeft()+mostCurrent._slot1.getWidth() && mostCurrent._word1.getTop()>=mostCurrent._slot1.getTop() && mostCurrent._word1.getTop()<=mostCurrent._slot1.getTop()+mostCurrent._slot1.getHeight()) { 
 //BA.debugLineNum = 376;BA.debugLine="word1.Left = slot1.Left + 5dip";
mostCurrent._word1.setLeft((int) (mostCurrent._slot1.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 377;BA.debugLine="word1.Top = slot1.Top + 5dip";
mostCurrent._word1.setTop((int) (mostCurrent._slot1.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 379;BA.debugLine="word1.Left = slot2.Left + 5dip";
mostCurrent._word1.setLeft((int) (mostCurrent._slot2.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 380;BA.debugLine="word1.Top = slot2.Top + 5dip";
...
mostCurrent._word1.setTag((Object)("OK"));
 ...
 //BA.debugLineNum = 388;BA.debugLine="word1.Left = slot4.Left + 5dip";
mostCurrent._word1.setLeft((int) (mostCurrent._slot4.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 389;BA.debugLine="word1.Top = slot4.Top + 5dip";
mostCurrent._word1.setTop((int) (mostCurrent._slot4.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 391;BA.debugLine="word1.Left = slot5.Left + 5dip";
mostCurrent._word1.setLeft((int) (mostCurrent._slot5.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 392;BA.debugLine="word1.Top = slot5.Top + 5dip";
...
public static boolean  _word1_ontouch(int _action,float _x,float _y,Object _motionevent) throws Exception{
 //BA.debugLineNum = 521;BA.debugLine="Sub word1_onTouch(Action As Int, X As Float, Y As";
 //BA.debugLineNum = 522;BA.debugLine="If Action = 1 Then";
if (_action==1) { 
 //BA.debugLineNum = 523;BA.debugLine="Chequear";
_chequear();
 };
...
int _newtop = 0;
 ...
 //BA.debugLineNum = 398;BA.debugLine="Dim newleft As Int = Max(0, Min(word2.Left + del";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word2.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word2.getWidth())));
 //BA.debugLineNum = 399;BA.debugLine="Dim newtop As Int = Max(0, Min(word2.Top + delta";
...
mostCurrent._checkok2.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 405;BA.debugLine="If word2.Left >= slot1.Left And word2.Left <= sl";
...
mostCurrent._word2.setTop((int) (mostCurrent._slot1.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 409;BA.debugLine="word2.Left = slot2.Left + 5dip";
mostCurrent._word2.setLeft((int) (mostCurrent._slot2.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 410;BA.debugLine="word2.Top = slot2.Top + 5dip";
mostCurrent._word2.setTop((int) (mostCurrent._slot2.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 412;BA.debugLine="word2.Left = slot3.Left + 5dip";
mostCurrent._word2.setLeft((int) (mostCurrent._slot3.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 413;BA.debugLine="word2.Top = slot3.Top + 5dip";
mostCurrent._word2.setTop((int) (mostCurrent._slot3.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 415;BA.debugLine="word2.Left = slot4.Left + 5dip";
mostCurrent._word2.setLeft((int) (mostCurrent._slot4.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 416;BA.debugLine="word2.Top = slot4.Top + 5dip";
...
mostCurrent._word2.setTag((Object)("OK"));
 ...
 //BA.debugLineNum = 421;BA.debugLine="word2.Left = slot5.Left + 5dip";
mostCurrent._word2.setLeft((int) (mostCurrent._slot5.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 422;BA.debugLine="word2.Top = slot5.Top + 5dip";
...
public static boolean  _word2_ontouch(int _action,float _x,float _y,Object _motionevent) throws Exception{
 //BA.debugLineNum = 528;BA.debugLine="Sub word2_onTouch(Action As Int, X As Float, Y As";
 //BA.debugLineNum = 529;BA.debugLine="If Action = 1 Then";
if (_action==1) { 
 //BA.debugLineNum = 530;BA.debugLine="Chequear";
_chequear();
 };
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 428;BA.debugLine="Sub word3_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 429;BA.debugLine="Dim newleft As Int = Max(0, Min(word3.Left + del";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word3.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word3.getWidth())));
 //BA.debugLineNum = 430;BA.debugLine="Dim newtop As Int = Max(0, Min(word3.Top + delta";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word3.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word3.getHeight())));
 //BA.debugLineNum = 431;BA.debugLine="word3.Left = newleft";
mostCurrent._word3.setLeft(_newleft);
 //BA.debugLineNum = 432;BA.debugLine="word3.Top = newtop";
mostCurrent._word3.setTop(_newtop);
 //BA.debugLineNum = 433;BA.debugLine="word3.Tag = \"\"";
mostCurrent._word3.setTag((Object)(""));
 //BA.debugLineNum = 434;BA.debugLine="checkOK3.Left = 6000dip";
mostCurrent._checkok3.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 435;BA.debugLine="checkOK3.Top = 6000dip";
mostCurrent._checkok3.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 436;BA.debugLine="If word3.Left >= slot1.Left And word3.Left <= sl";
if (mostCurrent._word3.getLeft()>=mostCurrent._slot1.getLeft() && mostCurrent._word3.getLeft()<=mostCurrent._slot1.getLeft()+mostCurrent._slot1.getWidth() && mostCurrent._word3.getTop()>=mostCurrent._slot1.getTop() && mostCurrent._word3.getTop()<=mostCurrent._slot1.getTop()+mostCurrent._slot1.getHeight()) { 
 //BA.debugLineNum = 437;BA.debugLine="word3.Left = slot1.Left + 5dip";
mostCurrent._word3.setLeft((int) (mostCurrent._slot1.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 438;BA.debugLine="word3.Top = slot1.Top + 5dip";
...
mostCurrent._word3.setTag((Object)("OK"));
 ...
 //BA.debugLineNum = 446;BA.debugLine="word3.Left = slot3.Left + 5dip";
mostCurrent._word3.setLeft((int) (mostCurrent._slot3.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 447;BA.debugLine="word3.Top = slot3.Top + 5dip";
mostCurrent._word3.setTop((int) (mostCurrent._slot3.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 449;BA.debugLine="word3.Left = slot4.Left + 5dip";
mostCurrent._word3.setLeft((int) (mostCurrent._slot4.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 450;BA.debugLine="word3.Top = slot4.Top + 5dip";
mostCurrent._word3.setTop((int) (mostCurrent._slot4.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 452;BA.debugLine="word3.Left = slot5.Left + 5dip";
mostCurrent._word3.setLeft((int) (mostCurrent._slot5.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 453;BA.debugLine="word3.Top = slot5.Top + 5dip";
...
public static boolean  _word3_ontouch(int _action,float _x,float _y,Object _motionevent) throws Exception{
 //BA.debugLineNum = 535;BA.debugLine="Sub word3_onTouch(Action As Int, X As Float, Y As";
 //BA.debugLineNum = 536;BA.debugLine="If Action = 1 Then";
if (_action==1) { 
 //BA.debugLineNum = 537;BA.debugLine="Chequear";
_chequear();
 };
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 458;BA.debugLine="Sub word4_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 459;BA.debugLine="Dim newleft As Int = Max(0, Min(word4.Left + del";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word4.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word4.getWidth())));
 //BA.debugLineNum = 460;BA.debugLine="Dim newtop As Int = Max(0, Min(word4.Top + delta";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word4.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word4.getHeight())));
 //BA.debugLineNum = 461;BA.debugLine="word4.Left = newleft";
mostCurrent._word4.setLeft(_newleft);
 //BA.debugLineNum = 462;BA.debugLine="word4.Top = newtop";
mostCurrent._word4.setTop(_newtop);
 //BA.debugLineNum = 463;BA.debugLine="word4.Tag = \"\"";
mostCurrent._word4.setTag((Object)(""));
 //BA.debugLineNum = 464;BA.debugLine="checkOK4.Left = 6000dip";
mostCurrent._checkok4.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 465;BA.debugLine="checkOK4.Top = 6000dip";
mostCurrent._checkok4.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 466;BA.debugLine="If word4.Left >= slot1.Left And word4.Left <= sl";
if (mostCurrent._word4.getLeft()>=mostCurrent._slot1.getLeft() && mostCurrent._word4.getLeft()<=mostCurrent._slot1.getLeft()+mostCurrent._slot1.getWidth() && mostCurrent._word4.getTop()>=mostCurrent._slot1.getTop() && mostCurrent._word4.getTop()<=mostCurrent._slot1.getTop()+mostCurrent._slot1.getHeight()) { 
 //BA.debugLineNum = 467;BA.debugLine="word4.Left = slot1.Left + 5dip";
mostCurrent._word4.setLeft((int) (mostCurrent._slot1.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 468;BA.debugLine="word4.Top = slot1.Top + 5dip";
mostCurrent._word4.setTop((int) (mostCurrent._slot1.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 470;BA.debugLine="word4.Left = slot2.Left + 5dip";
mostCurrent._word4.setLeft((int) (mostCurrent._slot2.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 471;BA.debugLine="word4.Top = slot2.Top + 5dip";
mostCurrent._word4.setTop((int) (mostCurrent._slot2.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 473;BA.debugLine="word4.Left = slot3.Left + 5dip";
mostCurrent._word4.setLeft((int) (mostCurrent._slot3.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 474;BA.debugLine="word4.Top = slot3.Top + 5dip";
mostCurrent._word4.setTop((int) (mostCurrent._slot3.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 477;BA.debugLine="word4.Left = slot4.Left + 5dip";
mostCurrent._word4.setLeft((int) (mostCurrent._slot4.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 478;BA.debugLine="word4.Top = slot4.Top + 5dip";
...
public static boolean  _word4_ontouch(int _action,float _x,float _y,Object _motionevent) throws Exception{
 //BA.debugLineNum = 542;BA.debugLine="Sub word4_onTouch(Action As Int, X As Float, Y As";
 //BA.debugLineNum = 543;BA.debugLine="If Action = 1 Then";
if (_action==1) { 
 //BA.debugLineNum = 544;BA.debugLine="Chequear";
_chequear();
 };
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 488;BA.debugLine="Sub word5_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 490;BA.debugLine="Dim newleft As Int = Max(0, Min(word5.Left + del";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word5.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word5.getWidth())));
 //BA.debugLineNum = 491;BA.debugLine="Dim newtop As Int = Max(0, Min(word5.Top + delta";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._word5.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._word5.getHeight())));
 //BA.debugLineNum = 492;BA.debugLine="word5.Left = newleft";
mostCurrent._word5.setLeft(_newleft);
 //BA.debugLineNum = 493;BA.debugLine="word5.Top = newtop";
mostCurrent._word5.setTop(_newtop);
 //BA.debugLineNum = 494;BA.debugLine="word5.Tag = \"\"";
mostCurrent._word5.setTag((Object)(""));
 //BA.debugLineNum = 495;BA.debugLine="checkOK5.Left = 6000dip";
mostCurrent._checkok5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 496;BA.debugLine="checkOK5.Top = 6000dip";
mostCurrent._checkok5.setTop(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6000)));
 //BA.debugLineNum = 498;BA.debugLine="If word5.Left >= slot1.Left And word5.Left <= sl";
...
mostCurrent._word5.setTag((Object)("OK"));
 ...
 //BA.debugLineNum = 505;BA.debugLine="word5.Left = slot2.Left + 5dip";
mostCurrent._word5.setLeft((int) (mostCurrent._slot2.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 506;BA.debugLine="word5.Top = slot2.Top + 5dip";
mostCurrent._word5.setTop((int) (mostCurrent._slot2.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 508;BA.debugLine="word5.Left = slot3.Left + 5dip";
mostCurrent._word5.setLeft((int) (mostCurrent._slot3.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 509;BA.debugLine="word5.Top = slot3.Top + 5dip";
mostCurrent._word5.setTop((int) (mostCurrent._slot3.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 511;BA.debugLine="word5.Left = slot4.Left + 5dip";
mostCurrent._word5.setLeft((int) (mostCurrent._slot4.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 512;BA.debugLine="word5.Top = slot4.Top + 5dip";
mostCurrent._word5.setTop((int) (mostCurrent._slot4.getTop()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 ...
 //BA.debugLineNum = 514;BA.debugLine="word5.Left = slot5.Left + 5dip";
mostCurrent._word5.setLeft((int) (mostCurrent._slot5.getLeft()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))));
 //BA.debugLineNum = 515;BA.debugLine="word5.Top = slot5.Top + 5dip";
...
public static boolean  _word5_ontouch(int _action,float _x,float _y,Object _motionevent) throws Exception{
 //BA.debugLineNum = 549;BA.debugLine="Sub word5_onTouch(Action As Int, X As Float, Y As";
 //BA.debugLineNum = 550;BA.debugLine="If Action = 1 Then";
if (_action==1) { 
 //BA.debugLineNum = 551;BA.debugLine="Chequear";
_chequear();
 };

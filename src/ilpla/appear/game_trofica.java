...
public class game_trofica extends Activity implements B4AActivity{
	public static game_trofica mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "ilpla.appear", "ilpla.appear.game_trofica");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (game_trofica).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ilpla.appear", "ilpla.appear.game_trofica");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ilpla.appear.game_trofica", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (game_trofica) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (game_trofica) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (game_trofica) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 56;BA.debugLine="If origen = \"aprender\" Then";
if ((_origen).equals("aprender")) { 
 //BA.debugLineNum = 57;BA.debugLine="verInstruccionesTrofica = True";
_verinstruccionestrofica = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 60;BA.debugLine="Activity.LoadLayout(\"Game_Trofica\")";
mostCurrent._activity.LoadLayout("Game_Trofica",mostCurrent.activityBA);
 //BA.debugLineNum = 61;BA.debugLine="inix1 = img1.Left";
_inix1 = mostCurrent._img1.getLeft();
 //BA.debugLineNum = 62;BA.debugLine="iniy1 = img1.Top";
_iniy1 = mostCurrent._img1.getTop();
 //BA.debugLineNum = 63;BA.debugLine="inix2 = img2.Left";
_inix2 = mostCurrent._img2.getLeft();
 //BA.debugLineNum = 64;BA.debugLine="inix3 = img3.Left";
_inix3 = mostCurrent._img3.getLeft();
 //BA.debugLineNum = 65;BA.debugLine="inix4 = img4.Left";
_inix4 = mostCurrent._img4.getLeft();
 //BA.debugLineNum = 66;BA.debugLine="inix5 = img5.Left";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 72;BA.debugLine="LoadLevel(currentlevel)";
...
String _okms = "";
 //BA.debugLineNum = 528;BA.debugLine="Sub btnCheck_Click";
 //BA.debugLineNum = 529;BA.debugLine="Dim currentsolucion As String";
_currentsolucion = "";
 //BA.debugLineNum = 530;BA.debugLine="currentsolucion = img1.Tag & img2.Tag & img3.Tag";
_currentsolucion = BA.ObjectToString(mostCurrent._img1.getTag())+BA.ObjectToString(mostCurrent._img2.getTag())+BA.ObjectToString(mostCurrent._img3.getTag())+BA.ObjectToString(mostCurrent._img4.getTag())+BA.ObjectToString(mostCurrent._img5.getTag());
 //BA.debugLineNum = 531;BA.debugLine="If currentsolucion = solucion Then";
if ((_currentsolucion).equals(mostCurrent._solucion)) { 
 //BA.debugLineNum = 532;BA.debugLine="Dim okms As String";
_okms = "";
 //BA.debugLineNum = 533;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 534;BA.debugLine="okms = utilidades.Mensaje(\"Correcto!!!\", \"Has c";
_okms = mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Correcto!!!","Has completado la cadena trófica correctamente!","Siguiente nivel","","Ver explicación");
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 537;BA.debugLine="okms = utilidades.Mensaje(\"Correct!!!\", \"You ha";
_okms = mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Correct!!!","You have completed the trophic network correctly!","Next level","","See explanation");
 };
 //BA.debugLineNum = 540;BA.debugLine="If okms = DialogResponse.POSITIVE Then";
if ((_okms).equals(BA.NumberToString(anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE))) { 
 //BA.debugLineNum = 541;BA.debugLine="currentlevel = currentlevel +1";
_currentlevel = (int) (_currentlevel+1);
 //BA.debugLineNum = 542;BA.debugLine="LoadLevel(currentlevel)";
_loadlevel(_currentlevel);
...
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 545;BA.debugLine="Msgbox(VerExplicacion(organismo1), \"Primer niv";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo1),"Primer nivel trófico",mostCurrent.activityBA);
 //BA.debugLineNum = 546;BA.debugLine="Msgbox(VerExplicacion(organismo2), \"Segundo ni";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo2),"Segundo nivel trófico",mostCurrent.activityBA);
 //BA.debugLineNum = 547;BA.debugLine="Msgbox(VerExplicacion(organismo3), \"Tercer niv";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo3),"Tercer nivel trófico",mostCurrent.activityBA);
 //BA.debugLineNum = 548;BA.debugLine="If organismo4 <> \"\" Then";
if ((mostCurrent._organismo4).equals("") == false) { 
 //BA.debugLineNum = 549;BA.debugLine="Msgbox(VerExplicacion(organismo4), \"Cuarto ni";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo4),"Cuarto nivel trófico",mostCurrent.activityBA);
 };
 //BA.debugLineNum = 551;BA.debugLine="If organismo5 <> \"\" Then";
if ((mostCurrent._organismo5).equals("") == false) { 
 //BA.debugLineNum = 552;BA.debugLine="Msgbox(VerExplicacion(organismo5), \"Quinto ni";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo5),"Quinto nivel trófico",mostCurrent.activityBA);
 };
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 555;BA.debugLine="Msgbox(VerExplicacion(organismo1), \"First trop";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo1),"First trophic level",mostCurrent.activityBA);
 //BA.debugLineNum = 556;BA.debugLine="Msgbox(VerExplicacion(organismo2), \"Second tro";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo2),"Second trophic level",mostCurrent.activityBA);
 //BA.debugLineNum = 557;BA.debugLine="Msgbox(VerExplicacion(organismo3), \"Third trop";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo3),"Third trophic level",mostCurrent.activityBA);
 //BA.debugLineNum = 558;BA.debugLine="If organismo4 <> \"\" Then";
if ((mostCurrent._organismo4).equals("") == false) { 
 //BA.debugLineNum = 559;BA.debugLine="Msgbox(VerExplicacion(organismo4), \"Fourth tr";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo4),"Fourth trophic level",mostCurrent.activityBA);
 };
 //BA.debugLineNum = 561;BA.debugLine="If organismo5 <> \"\" Then";
if ((mostCurrent._organismo5).equals("") == false) { 
 //BA.debugLineNum = 562;BA.debugLine="Msgbox(VerExplicacion(organismo5), \"Fifth tro";
anywheresoftware.b4a.keywords.Common.Msgbox(_verexplicacion(mostCurrent._organismo5),"Fifth trophic level",mostCurrent.activityBA);
 };
 };
 //BA.debugLineNum = 565;BA.debugLine="currentlevel = currentlevel +1";
_currentlevel = (int) (_currentlevel+1);
 //BA.debugLineNum = 566;BA.debugLine="LoadLevel(currentlevel)";
_loadlevel(_currentlevel);
 };
 }else {
 //BA.debugLineNum = 569;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 570;BA.debugLine="Msgbox(\"La cadena trófica no es correcta\",\"Prue";
anywheresoftware.b4a.keywords.Common.Msgbox("La cadena trófica no es correcta","Prueba de nuevo!",mostCurrent.activityBA);
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 572;BA.debugLine="Msgbox(\"The trophic network is not correct\",\"Tr";
anywheresoftware.b4a.keywords.Common.Msgbox("The trophic network is not correct","Try again!",mostCurrent.activityBA);
 };
 };
...
public static String  _butcerrar_click() throws Exception{
 //BA.debugLineNum = 643;BA.debugLine="Sub butCerrar_Click";
 //BA.debugLineNum = 644;BA.debugLine="Activity.RemoveAllViews";
...
public static String  _buthelp_click() throws Exception{
 //BA.debugLineNum = 648;BA.debugLine="Sub butHelp_Click";
 //BA.debugLineNum = 649;BA.debugLine="verInstruccionesTrofica = True";
_verinstruccionestrofica = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 650;BA.debugLine="p.SetScreenOrientation(1)";
...
public static String  _butok_click() throws Exception{
 //BA.debugLineNum = 150;BA.debugLine="Sub butOK_Click";
 //BA.debugLineNum = 151;BA.debugLine="verInstruccionesTrofica = False";
_verinstruccionestrofica = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 152;BA.debugLine="origen = \"\"";
_origen = "";
 //BA.debugLineNum = 153;BA.debugLine="p.SetScreenOrientation(0)";
mostCurrent._p.SetScreenOrientation(processBA,(int) (0));
 //BA.debugLineNum = 154;BA.debugLine="End Sub";
return "";
}
public static String  _butreset_click() throws Exception{
 //BA.debugLineNum = 637;BA.debugLine="Sub butReset_Click";
 //BA.debugLineNum = 638;BA.debugLine="Activity.RemoveAllViews";
mostCurrent._activity.RemoveAllViews();
 //BA.debugLineNum = 639;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 640;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,game_trofica.getObject());
...
anywheresoftware.b4a.objects.ButtonWrapper _butok = null;
 //BA.debugLineNum = 98;BA.debugLine="Sub CargaInstrucciones";
 //BA.debugLineNum = 99;BA.debugLine="If verInstruccionesTrofica = False Then";
if (_verinstruccionestrofica==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 100;BA.debugLine="currentlevel = 1";
_currentlevel = (int) (1);
 //BA.debugLineNum = 101;BA.debugLine="LoadLevel(currentlevel)";
_loadlevel(_currentlevel);
 //BA.debugLineNum = 102;BA.debugLine="TraducirGUI";
_traducirgui();
 //BA.debugLineNum = 103;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 108;BA.debugLine="Dim headerInst As Label";
_headerinst = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 109;BA.debugLine="headerInst.Initialize(\"\")";
_headerinst.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 110;BA.debugLine="headerInst.TextColor = Colors.Black";
_headerinst.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 111;BA.debugLine="headerInst.TextSize = 26";
_headerinst.setTextSize((float) (26));
 //BA.debugLineNum = 113;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 114;BA.debugLine="headerInst.Text = \"La cadena trófica\"";
_headerinst.setText((Object)("La cadena trófica"));
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 116;BA.debugLine="headerInst.Text = \"Trophic networks\"";
_headerinst.setText((Object)("Trophic networks"));
 };
 //BA.debugLineNum = 121;BA.debugLine="Dim textoInstruccion As Label";
_textoinstruccion = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 122;BA.debugLine="textoInstruccion.Initialize(\"\")";
_textoinstruccion.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 123;BA.debugLine="textoInstruccion.TextColor = Colors.Black";
_textoinstruccion.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 124;BA.debugLine="Dim panel1 As ScrollView";
_panel1 = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 125;BA.debugLine="panel1.Initialize(500dip)";
_panel1.Initialize(mostCurrent.activityBA,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (500)));
 //BA.debugLineNum = 126;BA.debugLine="panel1.Color = Colors.White";
_panel1.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 127;BA.debugLine="Dim lineInst As String";
_lineinst = "";
 //BA.debugLineNum = 128;BA.debugLine="lineInst = File.ReadString(File.DirAssets, Mai";
_lineinst = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang+"-troficaInst.txt");
 //BA.debugLineNum = 130;BA.debugLine="textoInstruccion.Text = lineInst";
_textoinstruccion.setText((Object)(_lineinst));
 //BA.debugLineNum = 133;BA.debugLine="Activity.AddView(panel1,0,0,100%x,100%y)";
mostCurrent._activity.AddView((android.view.View)(_panel1.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 134;BA.debugLine="panel1.Panel.AddView(headerInst,5%x,5%y,90%x,30di";
_panel1.getPanel().AddView((android.view.View)(_headerinst.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 135;BA.debugLine="panel1.Panel.AddView(textoInstruccion,5%x,5%y + 3";
_panel1.getPanel().AddView((android.view.View)(_textoinstruccion.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA)+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30))),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (90),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 139;BA.debugLine="Dim butOK As Button";
_butok = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 140;BA.debugLine="butOK.Initialize(\"butOK\")";
_butok.Initialize(mostCurrent.activityBA,"butOK");
 //BA.debugLineNum = 141;BA.debugLine="butOK.Text = \"OK\"";
_butok.setText((Object)("OK"));
 //BA.debugLineNum = 142;BA.debugLine="butOK.Color = Colors.ARGB(255,73,202,138)";
_butok.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (73),(int) (202),(int) (138)));
 //BA.debugLineNum = 143;BA.debugLine="butOK.TextColor = Colors.White";
_butok.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 145;BA.debugLine="Activity.AddView(butOK, 0,90%y,100%x,10%y)";
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 379;BA.debugLine="Sub img1_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 380;BA.debugLine="Dim newleft As Int = Max(0, Min(img1.Left + delta";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img1.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img1.getWidth())));
 //BA.debugLineNum = 381;BA.debugLine="Dim newtop As Int = Max(0, Min(img1.Top + deltaY,";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img1.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img1.getHeight())));
 //BA.debugLineNum = 382;BA.debugLine="img1.Left = newleft";
mostCurrent._img1.setLeft(_newleft);
 //BA.debugLineNum = 383;BA.debugLine="img1.Top = newtop";
mostCurrent._img1.setTop(_newtop);
 //BA.debugLineNum = 385;BA.debugLine="If img1.Left >= slot1.Left And img1.Left <= slot1";
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 407;BA.debugLine="Sub img2_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 408;BA.debugLine="Dim newleft As Int = Max(0, Min(img2.Left + delta";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img2.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img2.getWidth())));
 //BA.debugLineNum = 409;BA.debugLine="Dim newtop As Int = Max(0, Min(img2.Top + deltaY,";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img2.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img2.getHeight())));
 //BA.debugLineNum = 410;BA.debugLine="img2.Left = newleft";
mostCurrent._img2.setLeft(_newleft);
 //BA.debugLineNum = 411;BA.debugLine="img2.Top = newtop";
mostCurrent._img2.setTop(_newtop);
 //BA.debugLineNum = 413;BA.debugLine="If img2.Left >= slot1.Left And img2.Left <= slot1";
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 435;BA.debugLine="Sub img3_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 436;BA.debugLine="Dim newleft As Int = Max(0, Min(img3.Left + delta";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img3.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img3.getWidth())));
 //BA.debugLineNum = 437;BA.debugLine="Dim newtop As Int = Max(0, Min(img3.Top + deltaY,";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img3.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img3.getHeight())));
 //BA.debugLineNum = 438;BA.debugLine="img3.Left = newleft";
mostCurrent._img3.setLeft(_newleft);
 //BA.debugLineNum = 439;BA.debugLine="img3.Top = newtop";
mostCurrent._img3.setTop(_newtop);
 //BA.debugLineNum = 441;BA.debugLine="If img3.Left >= slot1.Left And img3.Left <= slot1";
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 463;BA.debugLine="Sub img4_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 464;BA.debugLine="Dim newleft As Int = Max(0, Min(img4.Left + delta";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img4.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img4.getWidth())));
 //BA.debugLineNum = 465;BA.debugLine="Dim newtop As Int = Max(0, Min(img4.Top + deltaY,";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img4.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img4.getHeight())));
 //BA.debugLineNum = 466;BA.debugLine="img4.Left = newleft";
mostCurrent._img4.setLeft(_newleft);
 //BA.debugLineNum = 467;BA.debugLine="img4.Top = newtop";
mostCurrent._img4.setTop(_newtop);
 //BA.debugLineNum = 469;BA.debugLine="If img4.Left >= slot1.Left And img4.Left <= slot1";
...
int _newleft = 0;
int _newtop = 0;
 //BA.debugLineNum = 491;BA.debugLine="Sub img5_onDrag(deltaX As Float, deltaY As Float,";
 //BA.debugLineNum = 492;BA.debugLine="Dim newleft As Int = Max(0, Min(img5.Left + delta";
_newleft = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img5.getLeft()+_deltax,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img5.getWidth())));
 //BA.debugLineNum = 493;BA.debugLine="Dim newtop As Int = Max(0, Min(img5.Top + deltaY,";
_newtop = (int) (anywheresoftware.b4a.keywords.Common.Max(0,anywheresoftware.b4a.keywords.Common.Min(mostCurrent._img5.getTop()+_deltay,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._img5.getHeight())));
 //BA.debugLineNum = 494;BA.debugLine="img5.Left = newleft";
mostCurrent._img5.setLeft(_newleft);
 //BA.debugLineNum = 495;BA.debugLine="img5.Top = newtop";
mostCurrent._img5.setTop(_newtop);
 //BA.debugLineNum = 497;BA.debugLine="If img5.Left >= slot1.Left And img5.Left <= slot1";
...
String _ms = "";
 //BA.debugLineNum = 163;BA.debugLine="Sub LoadLevel(numero As Int)";
 //BA.debugLineNum = 164;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 165;BA.debugLine="lblNivel.Text = \"Nivel: \" & numero & \"/10\"";
mostCurrent._lblnivel.setText((Object)("Nivel: "+BA.NumberToString(_numero)+"/10"));
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 167;BA.debugLine="lblNivel.Text = \"Level: \" & numero & \"/10\"";
mostCurrent._lblnivel.setText((Object)("Level: "+BA.NumberToString(_numero)+"/10"));
 };
 //BA.debugLineNum = 170;BA.debugLine="GD1.SetOnGestureListener(img1, \"img1\")";
mostCurrent._gd1.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._img1.getObject()),"img1");
 //BA.debugLineNum = 171;BA.debugLine="GD2.SetOnGestureListener(img2, \"img2\")";
mostCurrent._gd2.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._img2.getObject()),"img2");
 //BA.debugLineNum = 172;BA.debugLine="GD3.SetOnGestureListener(img3, \"img3\")";
mostCurrent._gd3.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._img3.getObject()),"img3");
 //BA.debugLineNum = 173;BA.debugLine="GD4.SetOnGestureListener(img4, \"img4\")";
mostCurrent._gd4.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._img4.getObject()),"img4");
 //BA.debugLineNum = 174;BA.debugLine="GD5.SetOnGestureListener(img5, \"img5\")";
mostCurrent._gd5.SetOnGestureListener(processBA,(android.view.View)(mostCurrent._img5.getObject()),"img5");
 //BA.debugLineNum = 177;BA.debugLine="slot1.Tag = \"1\"";
mostCurrent._slot1.setTag((Object)("1"));
 //BA.debugLineNum = 178;BA.debugLine="slot2.Tag = \"2\"";
mostCurrent._slot2.setTag((Object)("2"));
 //BA.debugLineNum = 179;BA.debugLine="slot3.Tag = \"3\"";
mostCurrent._slot3.setTag((Object)("3"));
 //BA.debugLineNum = 180;BA.debugLine="slot4.Tag = \"4\"";
mostCurrent._slot4.setTag((Object)("4"));
 //BA.debugLineNum = 181;BA.debugLine="slot5.Tag = \"5\"";
mostCurrent._slot5.setTag((Object)("5"));
 //BA.debugLineNum = 182;BA.debugLine="img1.Tag = \"\"";
mostCurrent._img1.setTag((Object)(""));
 //BA.debugLineNum = 183;BA.debugLine="img2.Tag = \"\"";
mostCurrent._img2.setTag((Object)(""));
 //BA.debugLineNum = 184;BA.debugLine="img3.Tag = \"\"";
mostCurrent._img3.setTag((Object)(""));
 //BA.debugLineNum = 185;BA.debugLine="img4.Tag = \"\"";
mostCurrent._img4.setTag((Object)(""));
 //BA.debugLineNum = 186;BA.debugLine="img5.Tag = \"\"";
mostCurrent._img5.setTag((Object)(""));
 //BA.debugLineNum = 187;BA.debugLine="organismo1 = \"\"";
mostCurrent._organismo1 = "";
 //BA.debugLineNum = 188;BA.debugLine="organismo2 = \"\"";
mostCurrent._organismo2 = "";
 //BA.debugLineNum = 189;BA.debugLine="organismo3 = \"\"";
mostCurrent._organismo3 = "";
 //BA.debugLineNum = 190;BA.debugLine="organismo4 = \"\"";
mostCurrent._organismo4 = "";
 //BA.debugLineNum = 191;BA.debugLine="organismo5 = \"\"";
mostCurrent._organismo5 = "";
 //BA.debugLineNum = 192;BA.debugLine="img1.Top = iniy1";
mostCurrent._img1.setTop(_iniy1);
 //BA.debugLineNum = 193;BA.debugLine="img2.Top = iniy1";
mostCurrent._img2.setTop(_iniy1);
 //BA.debugLineNum = 194;BA.debugLine="img3.Top = iniy1";
mostCurrent._img3.setTop(_iniy1);
 //BA.debugLineNum = 195;BA.debugLine="img4.Top = iniy1";
mostCurrent._img4.setTop(_iniy1);
 //BA.debugLineNum = 196;BA.debugLine="img5.Top = iniy1";
mostCurrent._img5.setTop(_iniy1);
 //BA.debugLineNum = 197;BA.debugLine="img1.Left = inix1";
mostCurrent._img1.setLeft(_inix1);
 //BA.debugLineNum = 198;BA.debugLine="img2.Left = inix2";
mostCurrent._img2.setLeft(_inix2);
 //BA.debugLineNum = 199;BA.debugLine="img3.Left = inix3";
mostCurrent._img3.setLeft(_inix3);
 //BA.debugLineNum = 200;BA.debugLine="img4.Left = inix4";
mostCurrent._img4.setLeft(_inix4);
 //BA.debugLineNum = 201;BA.debugLine="img5.Left = inix5";
mostCurrent._img5.setLeft(_inix5);
 //BA.debugLineNum = 202;BA.debugLine="img1.SetBackgroundImage(Null)";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 203;BA.debugLine="img2.SetBackgroundImage(Null)";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 204;BA.debugLine="img3.SetBackgroundImage(Null)";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 205;BA.debugLine="img4.SetBackgroundImage(Null)";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 206;BA.debugLine="img5.SetBackgroundImage(Null)";
mostCurrent._img5.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 209;BA.debugLine="If numero = 1 Then";
if (_numero==1) { 
 //BA.debugLineNum = 210;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 211;BA.debugLine="img4.Visible = False";
mostCurrent._img4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 212;BA.debugLine="slot4.Visible = False";
mostCurrent._slot4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 213;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 214;BA.debugLine="slot4.Left = 2000dip";
mostCurrent._slot4.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 215;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 217;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"3.gif").getObject()));
 //BA.debugLineNum = 218;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 219;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1.gif").getObject()));
 //BA.debugLineNum = 220;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 221;BA.debugLine="organismo2 = \"alga\"";
mostCurrent._organismo2 = "alga";
 //BA.debugLineNum = 222;BA.debugLine="organismo3 = \"zooplancton\"";
mostCurrent._organismo3 = "zooplancton";
 //BA.debugLineNum = 223;BA.debugLine="solucion = \"213\"";
mostCurrent._solucion = "213";
 }else if(_numero==2) { 
 //BA.debugLineNum = 225;BA.debugLine="img4.Visible = False";
mostCurrent._img4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 226;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 227;BA.debugLine="slot4.Visible = False";
mostCurrent._slot4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 228;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 229;BA.debugLine="slot4.Left = 2000dip";
mostCurrent._slot4.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 230;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 232;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"3.gif").getObject()));
 //BA.debugLineNum = 233;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.gif").getObject()));
 //BA.debugLineNum = 234;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 235;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 236;BA.debugLine="organismo2 = \"alga\"";
mostCurrent._organismo2 = "alga";
 //BA.debugLineNum = 237;BA.debugLine="organismo3 = \"zooplancton\"";
mostCurrent._organismo3 = "zooplancton";
 //BA.debugLineNum = 238;BA.debugLine="solucion = \"231\"";
mostCurrent._solucion = "231";
 }else if(_numero==3) { 
 //BA.debugLineNum = 240;BA.debugLine="img4.Visible = False";
mostCurrent._img4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 241;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 242;BA.debugLine="slot4.Visible = False";
mostCurrent._slot4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 243;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 244;BA.debugLine="slot4.Left = 2000dip";
mostCurrent._slot4.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 245;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 247;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 248;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"9.gif").getObject()));
 //BA.debugLineNum = 249;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"4.gif").getObject()));
 //BA.debugLineNum = 250;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 251;BA.debugLine="organismo2 = \"diatomea\"";
mostCurrent._organismo2 = "diatomea";
 //BA.debugLineNum = 252;BA.debugLine="organismo3 = \"caracol\"";
mostCurrent._organismo3 = "caracol";
 //BA.debugLineNum = 253;BA.debugLine="solucion = \"132\"";
mostCurrent._solucion = "132";
 }else if(_numero==4) { 
 //BA.debugLineNum = 255;BA.debugLine="img4.Visible = True";
mostCurrent._img4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 256;BA.debugLine="slot4.Visible = True";
mostCurrent._slot4.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 257;BA.debugLine="slot4.Left = slot3.Left + slot3.Width + 10dip";
mostCurrent._slot4.setLeft((int) (mostCurrent._slot3.getLeft()+mostCurrent._slot3.getWidth()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
 //BA.debugLineNum = 258;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 259;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 260;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 262;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 263;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"5.gif").getObject()));
 //BA.debugLineNum = 264;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"3.gif").getObject()));
 //BA.debugLineNum = 265;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1.gif").getObject()));
 //BA.debugLineNum = 266;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 267;BA.debugLine="organismo2 = \"alga\"";
mostCurrent._organismo2 = "alga";
 //BA.debugLineNum = 268;BA.debugLine="organismo3 = \"zooplancton\"";
mostCurrent._organismo3 = "zooplancton";
 //BA.debugLineNum = 269;BA.debugLine="organismo4 = \"peces\"";
mostCurrent._organismo4 = "peces";
 //BA.debugLineNum = 270;BA.debugLine="solucion = \"1423\"";
mostCurrent._solucion = "1423";
 }else if(_numero==5) { 
 //BA.debugLineNum = 272;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 273;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 274;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 276;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"8.gif").getObject()));
 //BA.debugLineNum = 277;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"4.gif").getObject()));
 //BA.debugLineNum = 278;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 279;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"9.gif").getObject()));
 //BA.debugLineNum = 280;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 281;BA.debugLine="organismo2 = \"alga\"";
mostCurrent._organismo2 = "alga";
 //BA.debugLineNum = 282;BA.debugLine="organismo3 = \"caracol\"";
mostCurrent._organismo3 = "caracol";
 //BA.debugLineNum = 283;BA.debugLine="organismo4 = \"aves\"";
mostCurrent._organismo4 = "aves";
 //BA.debugLineNum = 284;BA.debugLine="solucion = \"4213\"";
mostCurrent._solucion = "4213";
 }else if(_numero==6) { 
 //BA.debugLineNum = 286;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 287;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 288;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 290;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"5.gif").getObject()));
 //BA.debugLineNum = 291;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"3.gif").getObject()));
 //BA.debugLineNum = 292;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.gif").getObject()));
 //BA.debugLineNum = 293;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"8.gif").getObject()));
 //BA.debugLineNum = 294;BA.debugLine="organismo1 = \"alga\"";
mostCurrent._organismo1 = "alga";
 //BA.debugLineNum = 295;BA.debugLine="organismo2 = \"zooplancton\"";
mostCurrent._organismo2 = "zooplancton";
 //BA.debugLineNum = 296;BA.debugLine="organismo3 = \"peces\"";
mostCurrent._organismo3 = "peces";
 //BA.debugLineNum = 297;BA.debugLine="organismo4 = \"aves\"";
mostCurrent._organismo4 = "aves";
 //BA.debugLineNum = 298;BA.debugLine="solucion = \"3124\"";
mostCurrent._solucion = "3124";
 }else if(_numero==7) { 
 //BA.debugLineNum = 300;BA.debugLine="img5.Visible = False";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 301;BA.debugLine="slot5.Visible = False";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 302;BA.debugLine="slot5.Left = 2000dip";
mostCurrent._slot5.setLeft(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2000)));
 //BA.debugLineNum = 304;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"9.gif").getObject()));
 //BA.debugLineNum = 305;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"10.gif").getObject()));
 //BA.debugLineNum = 306;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 307;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"8.gif").getObject()));
 //BA.debugLineNum = 308;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 309;BA.debugLine="organismo2 = \"planta\"";
mostCurrent._organismo2 = "planta";
 //BA.debugLineNum = 310;BA.debugLine="organismo3 = \"caracol\"";
mostCurrent._organismo3 = "caracol";
 //BA.debugLineNum = 311;BA.debugLine="organismo4 = \"aves\"";
mostCurrent._organismo4 = "aves";
 //BA.debugLineNum = 312;BA.debugLine="solucion = \"3214\"";
mostCurrent._solucion = "3214";
 }else if(_numero==8) { 
 //BA.debugLineNum = 314;BA.debugLine="img5.Visible = True";
mostCurrent._img5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 315;BA.debugLine="slot5.Visible = True";
mostCurrent._slot5.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 316;BA.debugLine="slot5.Left = slot4.Left + slot4.Width + 10dip";
mostCurrent._slot5.setLeft((int) (mostCurrent._slot4.getLeft()+mostCurrent._slot4.getWidth()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))));
 //BA.debugLineNum = 319;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"8.gif").getObject()));
 //BA.debugLineNum = 320;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 321;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"3.gif").getObject()));
 //BA.debugLineNum = 322;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"1.gif").getObject()));
 //BA.debugLineNum = 323;BA.debugLine="img5.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img5.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"5.gif").getObject()));
 //BA.debugLineNum = 324;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 325;BA.debugLine="organismo2 = \"alga\"";
mostCurrent._organismo2 = "alga";
 //BA.debugLineNum = 326;BA.debugLine="organismo3 = \"zooplancton\"";
mostCurrent._organismo3 = "zooplancton";
 //BA.debugLineNum = 327;BA.debugLine="organismo4 = \"peces\"";
mostCurrent._organismo4 = "peces";
 //BA.debugLineNum = 328;BA.debugLine="organismo5 = \"aves\"";
mostCurrent._organismo5 = "aves";
 //BA.debugLineNum = 329;BA.debugLine="solucion = \"51234\"";
mostCurrent._solucion = "51234";
 }else if(_numero==9) { 
 //BA.debugLineNum = 332;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 333;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"4.gif").getObject()));
 //BA.debugLineNum = 334;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.gif").getObject()));
 //BA.debugLineNum = 335;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"5.gif").getObject()));
 //BA.debugLineNum = 336;BA.debugLine="img5.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img5.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"8.gif").getObject()));
 //BA.debugLineNum = 337;BA.debugLine="solucion = \"12345\"";
mostCurrent._solucion = "12345";
 //BA.debugLineNum = 338;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 339;BA.debugLine="organismo2 = \"diatomea\"";
mostCurrent._organismo2 = "diatomea";
 //BA.debugLineNum = 340;BA.debugLine="organismo3 = \"zooplancton\"";
mostCurrent._organismo3 = "zooplancton";
 //BA.debugLineNum = 341;BA.debugLine="organismo4 = \"peces\"";
mostCurrent._organismo4 = "peces";
 //BA.debugLineNum = 342;BA.debugLine="organismo5 = \"aves\"";
mostCurrent._organismo5 = "aves";
 }else if(_numero==10) { 
 //BA.debugLineNum = 345;BA.debugLine="img1.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img1.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"8.gif").getObject()));
 //BA.debugLineNum = 346;BA.debugLine="img2.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img2.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"4.gif").getObject()));
 //BA.debugLineNum = 347;BA.debugLine="img3.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img3.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"2.gif").getObject()));
 //BA.debugLineNum = 348;BA.debugLine="img4.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img4.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"9.gif").getObject()));
 //BA.debugLineNum = 349;BA.debugLine="img5.SetBackgroundImage(LoadBitmap(File.DirAsset";
mostCurrent._img5.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"11.gif").getObject()));
 //BA.debugLineNum = 350;BA.debugLine="organismo1 = \"sol\"";
mostCurrent._organismo1 = "sol";
 //BA.debugLineNum = 351;BA.debugLine="organismo2 = \"diatomea\"";
mostCurrent._organismo2 = "diatomea";
 //BA.debugLineNum = 352;BA.debugLine="organismo3 = \"zooplancton\"";
mostCurrent._organismo3 = "zooplancton";
 //BA.debugLineNum = 353;BA.debugLine="organismo4 = \"caracol\"";
mostCurrent._organismo4 = "caracol";
 //BA.debugLineNum = 354;BA.debugLine="organismo5 = \"aves\"";
mostCurrent._organismo5 = "aves";
 //BA.debugLineNum = 355;BA.debugLine="solucion = \"52341\"";
mostCurrent._solucion = "52341";
 }else if(_numero==11) { 
 //BA.debugLineNum = 357;BA.debugLine="Dim ms As String";
_ms = "";
 //BA.debugLineNum = 358;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 359;BA.debugLine="ms = utilidades.Mensaje(\"Ganaste!!!\", \"Felicita";
_ms = mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Ganaste!!!","Felicitaciones! has ganado todos los niveles","OK","","");
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 362;BA.debugLine="ms = utilidades.Mensaje(\"Congratulations!!!\", \"";
_ms = mostCurrent._utilidades._mensaje(mostCurrent.activityBA,"Congratulations!!!","You have won every level","OK","","");
 };
 //BA.debugLineNum = 365;BA.debugLine="If ms = DialogResponse.POSITIVE Then";
...
public static String  _traducirgui() throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Sub TraducirGUI";
 //BA.debugLineNum = 86;BA.debugLine="If Main.lang = \"en\" Then";
if ((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 87;BA.debugLine="btnCheck.Text = \"Check\"";
mostCurrent._btncheck.setText((Object)("Check"));
 //BA.debugLineNum = 88;BA.debugLine="Label1.Text = \"Complete the trophic network\"";
mostCurrent._label1.setText((Object)("Complete the trophic network"));
 };
 //BA.debugLineNum = 90;BA.debugLine="End Sub";
return "";
}
public static String  _verexplicacion(String _explicar) throws Exception{
 //BA.debugLineNum = 585;BA.debugLine="Sub VerExplicacion(explicar As String)";
 //BA.debugLineNum = 586;BA.debugLine="If Main.lang = \"es\" Then";
if ((mostCurrent._main._lang).equals("es")) { 
 //BA.debugLineNum = 587;BA.debugLine="If explicar = \"sol\" Then";
if ((_explicar).equals("sol")) { 
 //BA.debugLineNum = 588;BA.debugLine="Return \"El sol proporciona la energía lumínica";
if (true) return "El sol proporciona la energía lumínica al sistema";
 }else if((_explicar).equals("alga")) { 
 //BA.debugLineNum = 590;BA.debugLine="Return \"Las algas convierten la energía del sol";
if (true) return "Las algas convierten la energía del sol a energía química";
 }else if((_explicar).equals("zooplancton")) { 
 //BA.debugLineNum = 592;BA.debugLine="Return \"El zooplancton (tanto copépodos, rotífe";
if (true) return "El zooplancton (tanto copépodos, rotíferos o ciliados) se alimentan de las algas";
 ...
 //BA.debugLineNum = 594;BA.debugLine="Return \"Los peces comen zooplankton, algas u ot";
if (true) return "Los peces comen zooplankton, algas u otros peces";
 }else if((_explicar).equals("aves")) { 
 //BA.debugLineNum = 596;BA.debugLine="Return \"Las aves se alimentan de peces o de inv";
if (true) return "Las aves se alimentan de peces o de invertebrados, como caracoles y cangrejos";
 ...
 //BA.debugLineNum = 598;BA.debugLine="Return \"Las diatomeas son algas, que convierten";
if (true) return "Las diatomeas son algas, que convierten la energía del sol a energía química";
 ...
 //BA.debugLineNum = 600;BA.debugLine="Return \"Las macrófitas (o plantas acuáticas) co";
if (true) return "Las macrófitas (o plantas acuáticas) convierten la energía del sol a energía química";
 ...
 //BA.debugLineNum = 602;BA.debugLine="Return \"Los invertebrados (como los caracoles),";
if (true) return "Los invertebrados (como los caracoles), se alimentan de algas y plantas";
 };
 }else if((mostCurrent._main._lang).equals("en")) { 
 //BA.debugLineNum = 605;BA.debugLine="If explicar = \"sol\" Then";
if ((_explicar).equals("sol")) { 
 //BA.debugLineNum = 606;BA.debugLine="Return \"The sun provides the luminic energy int";
if (true) return "The sun provides the luminic energy into the system";
 }else if((_explicar).equals("alga")) { 
 //BA.debugLineNum = 608;BA.debugLine="Return \"Algae turn the luminic energy into chem";
if (true) return "Algae turn the luminic energy into chemical energy";
 }else if((_explicar).equals("zooplancton")) { 
 //BA.debugLineNum = 610;BA.debugLine="Return \"Zooplankton (copeopds, rotifers, ciliat";
if (true) return "Zooplankton (copeopds, rotifers, ciliates) eat the algae";
 }else if((_explicar).equals("peces")) { 
 //BA.debugLineNum = 612;BA.debugLine="Return \"Fish eat zooplankton, algae or even oth";
if (true) return "Fish eat zooplankton, algae or even other fish!";
 }else if((_explicar).equals("aves")) { 
 //BA.debugLineNum = 614;BA.debugLine="Return \"Birds feed on fish or invertebrates, su";
if (true) return "Birds feed on fish or invertebrates, such as snails and crabs";
 }else if((_explicar).equals("diatomea")) { 
 //BA.debugLineNum = 616;BA.debugLine="Return \"Diatoms are algae, that turn the lumini";
if (true) return "Diatoms are algae, that turn the luminic energy into chemical energy";
 }else if((_explicar).equals("planta")) { 
 //BA.debugLineNum = 618;BA.debugLine="Return \"Aquatic plants turn the luminic energy";
if (true) return "Aquatic plants turn the luminic energy into chemical energy";
 }else if((_explicar).equals("caracol")) { 
 //BA.debugLineNum = 620;BA.debugLine="Return \"Invertebrates (such as snails), feed on";

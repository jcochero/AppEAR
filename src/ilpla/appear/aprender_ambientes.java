...
public class aprender_ambientes extends Activity implements B4AActivity{
	public static aprender_ambientes mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "ilpla.appear", "ilpla.appear.aprender_ambientes");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (aprender_ambientes).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ilpla.appear", "ilpla.appear.aprender_ambientes");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ilpla.appear.aprender_ambientes", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (aprender_ambientes) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (aprender_ambientes) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return aprender_ambientes.class;
	}
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (aprender_ambientes) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (aprender_ambientes) Pause event (activity is not paused). **");
        if (mostCurrent != null)
    ...
    private static class ResumeMessage implements Runnable {
		...
		public void run() {
            aprender_ambientes mc = mostCurrent;
...
_titulo1.setText(BA.ObjectToCharSequence("Plain rivers"));
 //BA.debugLineNum = 50;BA.debugLine="titulo3.Text = \"Lakes\"";
_titulo3.setText(BA.ObjectToCharSequence("Lakes"));
 //BA.debugLineNum = 51;BA.debugLine="titulo4.Text = \"Estuaries\"";
_titulo4.setText(BA.ObjectToCharSequence("Estuaries"));
 //BA.debugLineNum = 52;BA.debugLine="titulo2.Text = \"Mountain rivers\"";
_titulo2.setText(BA.ObjectToCharSequence("Mountain rivers"));
 }else {
 //BA.debugLineNum = 54;BA.debugLine="titulo1.Text = \"Ríos de llanura\"";
_titulo1.setText(BA.ObjectToCharSequence("Ríos de llanura"));
 //BA.debugLineNum = 55;BA.debugLine="titulo3.Text = \"Lagos\"";
_titulo3.setText(BA.ObjectToCharSequence("Lagos"));
 //BA.debugLineNum = 56;BA.debugLine="titulo4.Text = \"Estuarios\"";
_titulo4.setText(BA.ObjectToCharSequence("Estuarios"));
 //BA.debugLineNum = 57;BA.debugLine="titulo2.Text = \"Ríos de montaña\"";
_titulo2.setText(BA.ObjectToCharSequence("Ríos de montaña"));
 };
...
_line1 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang /*String*/ +"-riollanura.txt");
...
_line2 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang /*String*/ +"-riomontana.txt");
...
_line3 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang /*String*/ +"-riolaguna.txt");
...
_line4 = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._main._lang /*String*/ +"-rioestuario.txt");
...
_texto4.setText(BA.ObjectToCharSequence(_line4));
 //BA.debugLineNum = 143;BA.debugLine="SD.panels(0).AddView(titulo1,10dip,0,100%x,5%y)";
mostCurrent._sd._panels[(int) (0)].AddView((android.view.View)(_titulo1.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 144;BA.debugLine="SD.panels(1).AddView(titulo2,10dip,0,100%x,5%y)";
mostCurrent._sd._panels[(int) (1)].AddView((android.view.View)(_titulo2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 145;BA.debugLine="SD.panels(2).AddView(titulo3,10dip,0,100%x,5%y)";
mostCurrent._sd._panels[(int) (2)].AddView((android.view.View)(_titulo3.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 146;BA.debugLine="SD.panels(3).AddView(titulo4,10dip,0,100%x,5%y)";
mostCurrent._sd._panels[(int) (3)].AddView((android.view.View)(_titulo4.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
